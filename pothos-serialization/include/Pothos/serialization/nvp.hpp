#ifndef POTHOS_SERIALIZATION_NVP_HPP
#define POTHOS_SERIALIZATION_NVP_HPP
...
struct implementation_level<nvp< T > >
{
    ...
    POTHOS_STATIC_CONSTANT(int, value = implementation_level::type::value);
};
...
struct tracking_level<nvp< T > >
{
    ...
    POTHOS_STATIC_CONSTANT(int, value = tracking_level::type::value);
};
...
#define POTHOS_SERIALIZATION_NVP(name)                              \
    Pothos::serialization::make_nvp(POTHOS_PP_STRINGIZE(name), name)
/**/

#define POTHOS_SERIALIZATION_BASE_OBJECT_NVP(name)                  \
    Pothos::serialization::make_nvp(                                \
        POTHOS_PP_STRINGIZE(name),                                  \
        Pothos::serialization::base_object<name >(*this)            \
    )
/**/

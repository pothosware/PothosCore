#ifndef POTHOS_SERIALIZATION_SMART_CAST_HPP
#define POTHOS_SERIALIZATION_SMART_CAST_HPP
            ...
            static T cast(U & u){
                ...
                || defined(__MWERKS__)
                    ...
                    typedef POTHOS_DEDUCED_TYPENAME mpl::eval_if<
                            POTHOS_DEDUCED_TYPENAME mpl::and_<
                                mpl::not_<is_base_and_derived<
                                    POTHOS_DEDUCED_TYPENAME remove_reference< T >::type,
                                    U
                                > >,
                                mpl::not_<is_base_and_derived<
                                    U,
                ...
                // if we're in debug mode
                    ...
                    typedef
                        POTHOS_DEDUCED_TYPENAME mpl::eval_if<
                            POTHOS_DEDUCED_TYPENAME mpl::and_<
                                mpl::not_<is_base_and_derived<
                                    POTHOS_DEDUCED_TYPENAME remove_pointer< T >::type,
                                    U
                                > >,
                                mpl::not_<is_base_and_derived<
                                    U,
    ...
    typedef
        POTHOS_DEDUCED_TYPENAME mpl::eval_if<
            POTHOS_DEDUCED_TYPENAME mpl::or_<
                Pothos::is_same<void *, U>,
                Pothos::is_same<void *, T>,
                Pothos::is_same<const void *, U>,
                Pothos::is_same<const void *, T>
            >,
            mpl::identity<smart_cast_impl::void_pointer< T > >,
        // else
        POTHOS_DEDUCED_TYPENAME mpl::eval_if<Pothos::is_pointer<U>,
            mpl::identity<smart_cast_impl::pointer< T > >,
        // else
        POTHOS_DEDUCED_TYPENAME mpl::eval_if<Pothos::is_reference<U>,

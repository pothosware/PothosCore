#ifndef POTHOS_SERIALIZATION_SERIALIZATION_HPP
#define POTHOS_SERIALIZATION_SERIALIZATION_HPP
...
POTHOS_STRONG_TYPEDEF(unsigned int, version_type)

// default implementation - call the member function "serialize"
template<class Archive, class T>
inline void serialize(
    Archive & ar, T & t, const POTHOS_PFTO unsigned int file_version
){

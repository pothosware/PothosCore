#ifndef POTHOS_SERIALIZATION_ASSUME_ABSTRACT_HPP
#define POTHOS_SERIALIZATION_ASSUME_ABSTRACT_HPP
...
#define POTHOS_SERIALIZATION_ASSUME_ABSTRACT(T)

// but forward to the "official" is_abstract
namespace Pothos {
namespace serialization {
    template<class T>
    struct is_abstract : Pothos::is_abstract< T > {} ;
} // namespace serialization
} // namespace boost
...
namespace serialization {
    template<class T>
    struct is_abstract : Pothos::false_type {};
} // namespace serialization
} // namespace boost
...
namespace serialization {                             \
template<>                                            \
struct is_abstract< T > : Pothos::true_type {};        \
template<>                                            \
struct is_abstract< const T > : Pothos::true_type {};  \
}}                                                    \
/**/

...
//
#ifndef POTHOS_NUMERIC_CONVERSION_CONVERTER_POLICIES_FLC_12NOV2002_HPP
#define POTHOS_NUMERIC_CONVERSION_CONVERTER_POLICIES_FLC_12NOV2002_HPP

#include <typeinfo> // for std::bad_cast

#include <Pothos/serialization/impl/config/no_tr1/cmath.hpp> // for std::floor and std::ceil
...
#else
    if ( r == cNegOverflow )
      ::Pothos::throw_exception(negative_overflow()) ;
    else if ( r == cPosOverflow )
           ::Pothos::throw_exception(positive_overflow()) ;
#endif
  }
} ;

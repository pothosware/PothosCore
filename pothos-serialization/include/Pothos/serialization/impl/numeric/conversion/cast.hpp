...
//
#ifndef POTHOS_NUMERIC_CONVERSION_CAST_25OCT2001_HPP
#define POTHOS_NUMERIC_CONVERSION_CAST_25OCT2001_HPP

#include <Pothos/serialization/impl/detail/workaround.hpp>

#if POTHOS_WORKAROUND(POTHOS_MSVC, < 1300) || POTHOS_WORKAROUND(__BORLANDC__, POTHOS_TESTED_AT(0x582))

#  include<Pothos/serialization/impl/numeric/conversion/detail/old_numeric_cast.hpp>

#else

#include <Pothos/serialization/impl/type.hpp>
#include <Pothos/serialization/impl/numeric/conversion/converter.hpp>
#include <Pothos/serialization/impl/numeric/conversion/numeric_cast_traits.hpp>
    ...
    inline Target numeric_cast( Source arg )
    {
        ...
        typedef Pothos::numeric::converter
            <
                ...
                Pothos::numeric::raw_converter< conv_traits >,

...
// 
#ifndef POTHOS_NUMERIC_CONVERSION_DETAIL_META_FLC_12NOV2002_HPP
#define POTHOS_NUMERIC_CONVERSION_DETAIL_META_FLC_12NOV2002_HPP
...
namespace Pothos { namespace numeric { namespace convdetail
{
   ...
   struct equal_to
   {
       ...
       enum { x = ( POTHOS_MPL_AUX_VALUE_WKND(T1)::value == POTHOS_MPL_AUX_VALUE_WKND(T2)::value ) };
           
       POTHOS_STATIC_CONSTANT(bool, value = x);
       ...
       POTHOS_STATIC_CONSTANT(bool, value = (
             POTHOS_MPL_AUX_VALUE_WKND(T1)::value 
               == POTHOS_MPL_AUX_VALUE_WKND(T2)::value
           ));

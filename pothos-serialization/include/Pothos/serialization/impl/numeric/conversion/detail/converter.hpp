...
//
#ifndef POTHOS_NUMERIC_CONVERSION_DETAIL_CONVERTER_FLC_12NOV2002_HPP
#define POTHOS_NUMERIC_CONVERSION_DETAIL_CONVERTER_FLC_12NOV2002_HPP

#include <functional>

#include "Pothos/serialization/impl/numeric/conversion/detail/meta.hpp"
#include "Pothos/serialization/impl/numeric/conversion/detail/conversion_traits.hpp"
#include "Pothos/serialization/impl/numeric/conversion/bounds.hpp"

#include "Pothos/serialization/impl/type_traits/is_same.hpp"

#include "Pothos/serialization/impl/mpl/integral_c.hpp"

namespace Pothos { namespace numeric { namespace convdetail
{
...
//--------------------------------------------------------------------------
  ...
  //
  template<class Traits>
  struct trivial_converter_impl : public std::unary_function<  POTHOS_DEDUCED_TYPENAME Traits::argument_type
                                                              ,POTHOS_DEDUCED_TYPENAME Traits::result_type
                                                            >
  ...
  struct rounding_converter : public std::unary_function<  POTHOS_DEDUCED_TYPENAME Traits::argument_type
                                                          ,POTHOS_DEDUCED_TYPENAME Traits::result_type
                                                        >
                             ,public RangeChecker
  ...
  struct non_rounding_converter : public std::unary_function< POTHOS_DEDUCED_TYPENAME Traits::argument_type
                                                             ,POTHOS_DEDUCED_TYPENAME Traits::result_type
                                                           >
                                 ,public RangeChecker
                                 ,public RawConverter
...
//--------------------------------------------------------------------------
  ...
  {
#if POTHOS_WORKAROUND(__BORLANDC__, POTHOS_TESTED_AT( 0x0561 ) )

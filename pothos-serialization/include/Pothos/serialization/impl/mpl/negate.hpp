...
#ifndef POTHOS_MPL_NEGATE_HPP_INCLUDED
#define POTHOS_MPL_NEGATE_HPP_INCLUDED
...
#endif
{
    POTHOS_MPL_AUX_LAMBDA_SUPPORT(1, negate, (N))
};

POTHOS_MPL_AUX_NA_SPEC(1, negate)
...
{
    POTHOS_STATIC_CONSTANT(T, value = -n);

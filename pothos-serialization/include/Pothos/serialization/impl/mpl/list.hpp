...
#ifndef POTHOS_MPL_LIST_HPP_INCLUDED
#define POTHOS_MPL_LIST_HPP_INCLUDED
...
#   define AUX778076_LIST_HEADER \
    POTHOS_PP_CAT(list,POTHOS_MPL_LIMIT_LIST_SIZE).hpp \
    /**/
#else
#   define AUX778076_LIST_HEADER \
    POTHOS_PP_CAT(list,POTHOS_MPL_LIMIT_LIST_SIZE)##.hpp \
...
#   include POTHOS_PP_STRINGIZE(Pothos/serialization/impl/mpl/list/AUX778076_LIST_HEADER)
...
#   define POTHOS_MPL_PREPROCESSED_HEADER list.hpp

...
#ifndef POTHOS_MPL_CLEAR_HPP_INCLUDED
#define POTHOS_MPL_CLEAR_HPP_INCLUDED
...
#include <Pothos/serialization/impl/mpl/clear_fwd.hpp>
#include <Pothos/serialization/impl/mpl/aux_/clear_impl.hpp>
...
{
    POTHOS_MPL_AUX_LAMBDA_SUPPORT(1,clear,(Sequence))
};

POTHOS_MPL_AUX_NA_SPEC(1, clear)

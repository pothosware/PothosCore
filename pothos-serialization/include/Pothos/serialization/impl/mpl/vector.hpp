...
#ifndef POTHOS_MPL_VECTOR_HPP_INCLUDED
#define POTHOS_MPL_VECTOR_HPP_INCLUDED
...
#   include POTHOS_PP_STRINGIZE(Pothos/serialization/impl/mpl/vector/AUX778076_VECTOR_HEADER)
...
#   define POTHOS_MPL_PREPROCESSED_HEADER vector.hpp

...
#ifndef POTHOS_MPL_COUNT_HPP_INCLUDED
#define POTHOS_MPL_COUNT_HPP_INCLUDED
...
#include <Pothos/serialization/impl/mpl/aux_/count_impl.hpp>
...
{
    POTHOS_MPL_AUX_LAMBDA_SUPPORT(2,count,(Sequence,T))
};

POTHOS_MPL_AUX_NA_SPEC(2, count)

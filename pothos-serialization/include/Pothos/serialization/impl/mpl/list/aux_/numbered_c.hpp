...
#   define MPL_AUX_LIST_C_TAIL(list, i, C) \
    POTHOS_PP_CAT(POTHOS_PP_CAT(list,POTHOS_PP_DEC(i)),_c)<T, \
      POTHOS_PP_ENUM_SHIFTED_PARAMS(i, C) \
    > \
    /**/
...
template<
    ...
    , POTHOS_PP_ENUM_PARAMS(i, T C)
    >
struct POTHOS_PP_CAT(POTHOS_PP_CAT(list,i),_c)
    : l_item<
          long_<i>
        , integral_c<T,C0>
        ...
        >
{
    typedef POTHOS_PP_CAT(POTHOS_PP_CAT(list,i),_c) type;
    typedef T value_type;
};

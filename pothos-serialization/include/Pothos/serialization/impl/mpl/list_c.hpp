...
#ifndef POTHOS_MPL_LIST_C_HPP_INCLUDED
#define POTHOS_MPL_LIST_C_HPP_INCLUDED
...
#   include <Pothos/serialization/impl/mpl/limits/list.hpp>
...
#   define AUX778076_LIST_C_HEADER \
    POTHOS_PP_CAT(POTHOS_PP_CAT(list,POTHOS_MPL_LIMIT_LIST_SIZE),_c).hpp \
    /**/
#else
#   define AUX778076_LIST_C_HEADER \
    POTHOS_PP_CAT(POTHOS_PP_CAT(list,POTHOS_MPL_LIMIT_LIST_SIZE),_c)##.hpp \
...
#   include POTHOS_PP_STRINGIZE(Pothos/serialization/impl/mpl/list/AUX778076_LIST_C_HEADER)
...
#   define POTHOS_MPL_PREPROCESSED_HEADER list_c.hpp
...
#   define AUX778076_SEQUENCE_LIMIT POTHOS_MPL_LIMIT_LIST_SIZE
#   define AUX778076_SEQUENCE_NAME_N(n) POTHOS_PP_CAT(POTHOS_PP_CAT(list,n),_c)

...
#ifndef POTHOS_MPL_AUX_TRAITS_LAMBDA_SPEC_HPP_INCLUDED
#define POTHOS_MPL_AUX_TRAITS_LAMBDA_SPEC_HPP_INCLUDED
...
#   define POTHOS_MPL_ALGORITM_TRAITS_LAMBDA_SPEC_IMPL(i, trait) /**/

#elif !defined(POTHOS_MPL_CFG_MSVC_ETI_BUG)

#   define POTHOS_MPL_ALGORITM_TRAITS_LAMBDA_SPEC_IMPL(i, trait) \
template<> struct trait<void_> \
{ \
    template< POTHOS_MPL_PP_PARAMS(i, typename T) > struct apply \
    { \
    }; \
}; \
/**/
...
#define POTHOS_MPL_ALGORITM_TRAITS_LAMBDA_SPEC(i, trait) \
    POTHOS_MPL_ALGORITM_TRAITS_LAMBDA_SPEC_IMPL(i, trait) \

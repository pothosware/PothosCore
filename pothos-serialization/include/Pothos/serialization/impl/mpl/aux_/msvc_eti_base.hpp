...
#ifndef POTHOS_MPL_AUX_MSVC_ETI_BASE_HPP_INCLUDED
#define POTHOS_MPL_AUX_MSVC_ETI_BASE_HPP_INCLUDED
...
template< typename T > struct msvc_eti_base
    : T
{
#if POTHOS_WORKAROUND(POTHOS_MPL_CFG_GCC, POTHOS_TESTED_AT(0x0304))
    msvc_eti_base();
#endif
    typedef T type;
};

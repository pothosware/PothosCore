...
#ifndef POTHOS_MPL_AUX_ERASE_KEY_IMPL_HPP_INCLUDED
#define POTHOS_MPL_AUX_ERASE_KEY_IMPL_HPP_INCLUDED
...
POTHOS_MPL_ALGORITM_TRAITS_LAMBDA_SPEC(2, erase_key_impl)

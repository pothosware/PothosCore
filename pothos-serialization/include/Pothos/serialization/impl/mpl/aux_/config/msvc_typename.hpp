...
#ifndef POTHOS_MPL_AUX_CONFIG_MSVC_TYPENAME_HPP_INCLUDED
#define POTHOS_MPL_AUX_CONFIG_MSVC_TYPENAME_HPP_INCLUDED
...
#   define POTHOS_MSVC_TYPENAME
#else
#   define POTHOS_MSVC_TYPENAME typename
#endif

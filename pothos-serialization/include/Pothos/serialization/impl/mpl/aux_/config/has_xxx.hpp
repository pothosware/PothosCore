...
#ifndef POTHOS_MPL_AUX_CONFIG_HAS_XXX_HPP_INCLUDED
#define POTHOS_MPL_AUX_CONFIG_HAS_XXX_HPP_INCLUDED
...
#   define POTHOS_MPL_CFG_NO_HAS_XXX
#   define POTHOS_MPL_CFG_NO_HAS_XXX_TEMPLATE

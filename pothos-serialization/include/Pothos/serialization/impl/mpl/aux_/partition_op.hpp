...
#ifndef POTHOS_MPL_AUX_PARTITION_OP_HPP_INCLUDED
#define POTHOS_MPL_AUX_PARTITION_OP_HPP_INCLUDED
...
POTHOS_MPL_AUX_PASS_THROUGH_LAMBDA_SPEC(3, aux::partition_op)

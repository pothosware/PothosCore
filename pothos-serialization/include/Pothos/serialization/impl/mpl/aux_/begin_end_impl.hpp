...
#ifndef POTHOS_MPL_AUX_BEGIN_END_IMPL_HPP_INCLUDED
#define POTHOS_MPL_AUX_BEGIN_END_IMPL_HPP_INCLUDED
...
POTHOS_MPL_ALGORITM_TRAITS_LAMBDA_SPEC_IMPL(1,begin_impl)
POTHOS_MPL_ALGORITM_TRAITS_LAMBDA_SPEC_IMPL(1,end_impl)

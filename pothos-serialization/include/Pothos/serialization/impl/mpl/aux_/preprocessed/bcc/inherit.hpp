...
POTHOS_MPL_AUX_NA_SPEC(3, inherit3)
...
POTHOS_MPL_AUX_NA_SPEC(4, inherit4)
...
POTHOS_MPL_AUX_NA_SPEC(5, inherit5)
...
POTHOS_MPL_AUX_NA_SPEC_LAMBDA(5, inherit)
POTHOS_MPL_AUX_NA_SPEC_ARITY(5, inherit)
POTHOS_MPL_AUX_NA_SPEC_TEMPLATE_ARITY(5, 5, inherit)
}}

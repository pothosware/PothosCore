...
{
    POTHOS_MPL_AUX_LAMBDA_SUPPORT(2, not_equal_to, (N1, N2))

};

POTHOS_MPL_AUX_NA_SPEC2(2, 2, not_equal_to)
...
struct not_equal_to_impl< integral_c_tag,integral_c_tag >
{
    template< typename N1, typename N2 > struct apply
        ...
        : bool_< ( POTHOS_MPL_AUX_VALUE_WKND(N1)::value != POTHOS_MPL_AUX_VALUE_WKND(N2)::value ) >
    {
    };
};

...
#ifndef POTHOS_MPL_INT_FWD_HPP_INCLUDED
#define POTHOS_MPL_INT_FWD_HPP_INCLUDED
...
template< POTHOS_MPL_AUX_NTTP_DECL(int, N) > struct int_;

POTHOS_MPL_AUX_ADL_BARRIER_NAMESPACE_CLOSE
POTHOS_MPL_AUX_ADL_BARRIER_DECL(int_)

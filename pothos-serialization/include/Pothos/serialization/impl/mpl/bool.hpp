...
#ifndef POTHOS_MPL_BOOL_HPP_INCLUDED
#define POTHOS_MPL_BOOL_HPP_INCLUDED
...
#include <Pothos/serialization/impl/mpl/bool_fwd.hpp>
...
{
    POTHOS_STATIC_CONSTANT(bool, value = C_);

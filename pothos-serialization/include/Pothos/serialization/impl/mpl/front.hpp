...
#ifndef POTHOS_MPL_FRONT_HPP_INCLUDED
#define POTHOS_MPL_FRONT_HPP_INCLUDED
...
#include <Pothos/serialization/impl/mpl/aux_/front_impl.hpp>
...
{
    POTHOS_MPL_AUX_LAMBDA_SUPPORT(1,front,(Sequence))
};

POTHOS_MPL_AUX_NA_SPEC(1, front)

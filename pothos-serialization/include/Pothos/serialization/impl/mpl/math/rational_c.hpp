...
#ifndef POTHOS_MPL_RATIONAL_C_HPP_INCLUDED
#define POTHOS_MPL_RATIONAL_C_HPP_INCLUDED
...
struct rational_c
{
    POTHOS_STATIC_CONSTANT(IntegerType, numerator = N);
    POTHOS_STATIC_CONSTANT(IntegerType, denominator = D);

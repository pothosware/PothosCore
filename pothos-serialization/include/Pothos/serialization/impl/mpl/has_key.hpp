...
#ifndef POTHOS_MPL_HAS_KEY_HPP_INCLUDED
#define POTHOS_MPL_HAS_KEY_HPP_INCLUDED
...
#include <Pothos/serialization/impl/mpl/aux_/has_key_impl.hpp>
...
{
    POTHOS_MPL_AUX_LAMBDA_SUPPORT(2,has_key,(AssociativeSequence,Key))
};

POTHOS_MPL_AUX_NA_SPEC(2, has_key)

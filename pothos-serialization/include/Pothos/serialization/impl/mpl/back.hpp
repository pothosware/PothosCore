...
#ifndef POTHOS_MPL_BACK_HPP_INCLUDED
#define POTHOS_MPL_BACK_HPP_INCLUDED
...
#include <Pothos/serialization/impl/mpl/aux_/back_impl.hpp>
...
{
    POTHOS_MPL_AUX_LAMBDA_SUPPORT(1,back,(Sequence))
};

POTHOS_MPL_AUX_NA_SPEC(1, back)

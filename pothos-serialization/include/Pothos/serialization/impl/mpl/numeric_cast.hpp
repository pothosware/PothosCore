...
#ifndef POTHOS_MPL_NUMERIC_CAST_HPP_INCLUDED
#define POTHOS_MPL_NUMERIC_CAST_HPP_INCLUDED
...
#if POTHOS_WORKAROUND(POTHOS_MSVC, <= 1300) || POTHOS_WORKAROUND(__BORLANDC__, POTHOS_TESTED_AT(0x570) )
#   define POTHOS_MPL_AUX_NUMERIC_CAST numeric_cast_
#else
#   define POTHOS_MPL_AUX_NUMERIC_CAST numeric_cast
#endif
...
template< typename SourceTag, typename TargetTag > struct POTHOS_MPL_AUX_NUMERIC_CAST
{

...
#ifndef POTHOS_MPL_FOLD_HPP_INCLUDED
#define POTHOS_MPL_FOLD_HPP_INCLUDED
...
#include <Pothos/serialization/impl/mpl/aux_/fold_impl.hpp>
...
struct fold
{
    ...
    POTHOS_MPL_AUX_LAMBDA_SUPPORT(3,fold,(Sequence,State,ForwardOp))
};

POTHOS_MPL_AUX_NA_SPEC(3, fold)

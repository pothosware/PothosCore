#ifndef POTHOS_SMART_PTR_DETAIL_SHARED_PTR_NMT_HPP_INCLUDED
#define POTHOS_SMART_PTR_DETAIL_SHARED_PTR_NMT_HPP_INCLUDED
...
#include <Pothos/serialization/impl/smart_ptr/detail/atomic_count.hpp>

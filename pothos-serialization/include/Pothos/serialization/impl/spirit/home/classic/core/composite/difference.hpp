...
=============================================================================*/
#if !defined(POTHOS_SPIRIT_DIFFERENCE_HPP)
#define POTHOS_SPIRIT_DIFFERENCE_HPP
...
#pragma warning(pop)
    ...
    struct difference_parser_gen
    {
        ...
        {
            return difference<POTHOS_DEDUCED_TYPENAME as_parser<A>::type,
...
#include <Pothos/serialization/impl/spirit/home/classic/core/composite/impl/difference.ipp>

...
=============================================================================*/
#if !defined(POTHOS_SPIRIT_EXCLUSIVE_OR_HPP)
#define POTHOS_SPIRIT_EXCLUSIVE_OR_HPP
...
POTHOS_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    struct exclusive_or_parser_gen
    {
        ...
        {
            return exclusive_or<POTHOS_DEDUCED_TYPENAME as_parser<A>::type,
...
#include <Pothos/serialization/impl/spirit/home/classic/core/composite/impl/exclusive_or.ipp>

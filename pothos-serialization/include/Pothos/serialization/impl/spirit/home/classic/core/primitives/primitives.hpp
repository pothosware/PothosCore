...
=============================================================================*/
#if !defined(POTHOS_SPIRIT_PRIMITIVES_HPP)
#define POTHOS_SPIRIT_PRIMITIVES_HPP
...
#include <Pothos/serialization/impl/spirit/home/classic/core/composite/impl/directives.ipp>
#include <Pothos/serialization/impl/spirit/home/classic/core/primitives/impl/primitives.ipp>
...
POTHOS_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    struct range : public char_parser<range<CharT> >
    {
        ...
        {
            POTHOS_SPIRIT_ASSERT(!(last < first));
        }
    ...
    public:
        ...
        parse(ScannerT const& scan) const
        {
            typedef typename Pothos::unwrap_reference<IteratorT>::type striter_t;
            typedef typename parser_result<self_t, ScannerT>::type result_t;

...
=============================================================================*/
#if !defined(POTHOS_SPIRIT_ALTERNATIVE_HPP)
#define POTHOS_SPIRIT_ALTERNATIVE_HPP
...
#pragma warning(pop)
    ...
    struct alternative_parser_gen
    {
        ...
        {
            return alternative<POTHOS_DEDUCED_TYPENAME as_parser<A>::type,
...
#include <Pothos/serialization/impl/spirit/home/classic/core/composite/impl/alternative.ipp>

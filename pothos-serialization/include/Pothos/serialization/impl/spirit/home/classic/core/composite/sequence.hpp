...
=============================================================================*/
#if !defined(POTHOS_SPIRIT_SEQUENCE_HPP)
#define POTHOS_SPIRIT_SEQUENCE_HPP
...
#pragma warning(pop)
    ...
    struct sequence_parser_gen
    {
        ...
        {
            return sequence<POTHOS_DEDUCED_TYPENAME as_parser<A>::type,
...
#include <Pothos/serialization/impl/spirit/home/classic/core/composite/impl/sequence.ipp>

...
=============================================================================*/
#if !defined(POTHOS_SPIRIT_INTERSECTION_HPP)
#define POTHOS_SPIRIT_INTERSECTION_HPP
...
POTHOS_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    struct intersection_parser_gen
    {
        ...
        {
            return intersection<POTHOS_DEDUCED_TYPENAME as_parser<A>::type,
...
#include <Pothos/serialization/impl/spirit/home/classic/core/composite/impl/intersection.ipp>

...
=============================================================================*/
#if !defined(POTHOS_SPIRIT_SEQUENTIAL_OR_HPP)
#define POTHOS_SPIRIT_SEQUENTIAL_OR_HPP
...
POTHOS_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    struct sequential_or_parser_gen
    {
        ...
        {
            return sequential_or<POTHOS_DEDUCED_TYPENAME as_parser<A>::type,
                POTHOS_DEDUCED_TYPENAME as_parser<B>::type>
...
#include <Pothos/serialization/impl/spirit/home/classic/core/composite/impl/sequential_or.ipp>

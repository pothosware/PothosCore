...
=============================================================================*/
#if !defined(POTHOS_SPIRIT_RULE_HPP)
#define POTHOS_SPIRIT_RULE_HPP
...
//
///////////////////////////////////////////////////////////////////////////////
#if !defined(POTHOS_SPIRIT_RULE_SCANNERTYPE_LIMIT)
#  define POTHOS_SPIRIT_RULE_SCANNERTYPE_LIMIT 1
#endif

//  Ensure a meaningful maximum number of simultaneously usable scanner types
POTHOS_STATIC_ASSERT(POTHOS_SPIRIT_RULE_SCANNERTYPE_LIMIT > 0);

#include <Pothos/serialization/impl/scoped_ptr.hpp>
#include <Pothos/serialization/impl/spirit/home/classic/namespace.hpp>
#include <Pothos/serialization/impl/spirit/home/classic/core/non_terminal/impl/rule.ipp>

...
=============================================================================*/
#ifndef POTHOS_SPIRIT_RANGE_RUN_IPP
#define POTHOS_SPIRIT_RANGE_RUN_IPP

///////////////////////////////////////////////////////////////////////////////
#include <algorithm> // for std::lower_bound
#include <Pothos/serialization/impl/spirit/home/classic/core/assert.hpp> // for BOOST_SPIRIT_ASSERT
#include <Pothos/serialization/impl/spirit/home/classic/utility/impl/chset/range_run.hpp>
#include <Pothos/serialization/impl/spirit/home/classic/debug.hpp>
...
POTHOS_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    namespace utility { namespace impl {
        ...
        {
            POTHOS_SPIRIT_ASSERT(r.is_valid());
            if (!run.empty())
            {
                iterator iter =
                    std::lower_bound(

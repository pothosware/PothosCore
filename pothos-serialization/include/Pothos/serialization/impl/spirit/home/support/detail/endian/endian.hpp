...
#ifndef POTHOS_SPIRIT_ENDIAN_HPP
#define POTHOS_SPIRIT_ENDIAN_HPP

#if defined(_MSC_VER)
#pragma once
#endif

#ifdef POTHOS_ENDIAN_LOG
# include <iostream>
#endif
...
#define POTHOS_MINIMAL_INTEGER_COVER_OPERATORS
#define POTHOS_NO_IO_COVER_OPERATORS
#include <Pothos/serialization/impl/spirit/home/support/detail/endian/cover_operators.hpp>
#undef  POTHOS_NO_IO_COVER_OPERATORS
#undef  POTHOS_MINIMAL_INTEGER_COVER_OPERATORS
...
#include <Pothos/serialization/impl/spirit/home/support/detail/scoped_enum_emulation.hpp>
#include <iosfwd>
#include <climits>
...
# define POTHOS_ENDIAN_DEFAULT_CONSTRUCT {}          // C++03

# if defined(POTHOS_ENDIAN_FORCE_PODNESS)
#   define POTHOS_ENDIAN_NO_CTORS
# endif
...
namespace Pothos { namespace spirit
{
  namespace detail
  {
    ...
    template <typename T, std::size_t n_bytes,
      bool sign=Pothos::is_signed<T>::value >
...
# endif
  ...
  POTHOS_SCOPED_ENUM_START(endianness) { big, little, native }; POTHOS_SCOPED_ENUM_END
  POTHOS_SCOPED_ENUM_START(alignment) { unaligned, aligned }; POTHOS_SCOPED_ENUM_END

  template <POTHOS_SCOPED_ENUM(endianness) E, typename T, std::size_t n_bits,
    POTHOS_SCOPED_ENUM(alignment) A = alignment::unaligned>
    class endian;
    ...
    {
        POTHOS_STATIC_ASSERT( (n_bits/8)*8 == n_bits );
      public:
        typedef T value_type;
#     ifndef POTHOS_ENDIAN_NO_CTORS
        endian() POTHOS_ENDIAN_DEFAULT_CONSTRUCT
...
#   endif
    ...
    {
        POTHOS_STATIC_ASSERT( (n_bits/8)*8 == n_bits );
        POTHOS_STATIC_ASSERT( sizeof(T) == n_bits/8 );
      public:
        typedef T value_type;
#   ifndef POTHOS_ENDIAN_NO_CTORS
        endian() POTHOS_ENDIAN_DEFAULT_CONSTRUCT
...
#define POTHOS_HAS_INT16_T
#define POTHOS_HAS_INT32_T
#define POTHOS_HAS_INT64_T
...
namespace Pothos { namespace endian
{
    using namespace Pothos::spirit::endian;
}}

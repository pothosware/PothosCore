...
#ifndef POTHOS_SPIRIT_MATH_FPCLASSIFY_HPP
#define POTHOS_SPIRIT_MATH_FPCLASSIFY_HPP
...
#include <Pothos/serialization/impl/spirit/home/support/detail/math/detail/fp_traits.hpp>
...
template<class T> bool (isinf)(T x)
{
    typedef POTHOS_DEDUCED_TYPENAME detail::fp_traits<T>::type traits;
    traits::init();
    return detail::isinf_impl(x, POTHOS_DEDUCED_TYPENAME traits::coverage());
}
...
template<class T> bool (isnan)(T x)
{
    typedef POTHOS_DEDUCED_TYPENAME detail::fp_traits<T>::type traits;
    traits::init();
    return detail::isnan_impl(x, POTHOS_DEDUCED_TYPENAME traits::coverage());
}
...
template<class T> int (fpclassify)(T x)
{
    typedef POTHOS_DEDUCED_TYPENAME detail::fp_traits<T>::type traits;
    traits::init();
    return detail::fpclassify_impl(x, POTHOS_DEDUCED_TYPENAME traits::coverage());
}

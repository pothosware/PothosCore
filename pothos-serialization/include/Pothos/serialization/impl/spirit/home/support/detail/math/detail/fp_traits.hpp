...
#ifndef POTHOS_SPIRIT_MATH_FP_TRAITS_HPP
#define POTHOS_SPIRIT_MATH_FP_TRAITS_HPP
...
template<class T, class U> struct fp_traits_impl
{
    ...
    typedef POTHOS_DEDUCED_TYPENAME uint32_t_coverage<U>::type coverage;

    POTHOS_STATIC_CONSTANT(uint32_t, sign = 0x80000000);
...
template<> struct fp_traits_impl<float, single_precision_tag>
{
    ...
    POTHOS_STATIC_CONSTANT(uint32_t, mantissa = 0x007fffff);
...
template<> struct fp_traits_impl<double, double_precision_tag>
{
    ...
    POTHOS_STATIC_CONSTANT(uint32_t, mantissa = 0x000fffff);
...
template<> struct fp_traits_impl<long double, extended_double_precision_tag>
{
    ...
    POTHOS_STATIC_CONSTANT(uint32_t, mantissa = 0x00007fff);
...
template<> struct fp_traits_impl<long double, extended_double_precision_tag>
{
    ...
    POTHOS_STATIC_CONSTANT(uint32_t, exponent = 0x7fff0000);
    POTHOS_STATIC_CONSTANT(uint32_t, flag     = 0x00000000);
    POTHOS_STATIC_CONSTANT(uint32_t, mantissa = 0x0000ffff);
...
{
    POTHOS_STATIC_ASSERT(Pothos::is_floating_point<T>::value);
    typedef POTHOS_DEDUCED_TYPENAME size_to_precision<sizeof(T)>::type precision;

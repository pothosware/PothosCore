...
#ifndef POTHOS_TT_IS_VOLATILE_HPP_INCLUDED
#define POTHOS_TT_IS_VOLATILE_HPP_INCLUDED
...
{
#if POTHOS_WORKAROUND(POTHOS_MSVC, < 1400)
   POTHOS_STATIC_CONSTANT(bool, value = ::Pothos::detail::cv_traits_imp<typename Pothos::remove_bounds<T>::type*>::is_volatile);
#else
   POTHOS_STATIC_CONSTANT(bool, value = ::Pothos::detail::cv_traits_imp<T*>::is_volatile);
#endif
};
...
POTHOS_TT_AUX_BOOL_TRAIT_DEF1(is_volatile,T,__is_volatile(T))
#elif !defined(POTHOS_NO_TEMPLATE_PARTIAL_SPECIALIZATION)

//* is a type T declared volatile - is_volatile<T>
POTHOS_TT_AUX_BOOL_TRAIT_DEF1(is_volatile,T,::Pothos::detail::is_volatile_rval_filter<T>::value)
POTHOS_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_volatile,T&,false)
...
POTHOS_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_volatile,T& const,false)
POTHOS_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_volatile,T& volatile,false)
POTHOS_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC1_1(typename T,is_volatile,T& const volatile,false)
#endif
...
struct is_volatile_helper<false,false>
{
    template <typename T> struct result_
    {
        ...
        POTHOS_STATIC_CONSTANT(bool, value = (
            sizeof(Pothos::detail::yes_type) == sizeof(Pothos::detail::is_volatile_tester(t))
            ));
    };
};
...
POTHOS_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_volatile,void,false)
#ifndef POTHOS_NO_CV_VOID_SPECIALIZATIONS
POTHOS_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_volatile,void const,false)
POTHOS_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_volatile,void volatile,true)
POTHOS_TT_AUX_BOOL_TRAIT_IMPL_SPEC1(is_volatile,void const volatile,true)
#endif

} // namespace detail

//* is a type T declared volatile - is_volatile<T>
POTHOS_TT_AUX_BOOL_TRAIT_DEF1(is_volatile,T,::Pothos::detail::is_volatile_impl<T>::value)

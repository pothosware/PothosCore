...
#ifndef POTHOS_TT_IS_BASE_AND_DERIVED_HPP_INCLUDED
#define POTHOS_TT_IS_BASE_AND_DERIVED_HPP_INCLUDED

#include <Pothos/serialization/impl/type_traits/intrinsics.hpp>
#ifndef POTHOS_IS_BASE_OF
...
namespace detail {
 ...
 && !POTHOS_WORKAROUND(__SUNPRO_CC , <= 0x540) \
...
#pragma warning(disable:6334)
    ...
    //
    POTHOS_STATIC_ASSERT(sizeof(B) != 0);
    POTHOS_STATIC_ASSERT(sizeof(D) != 0);
...
{
    POTHOS_STATIC_CONSTANT(bool, value =
        (::Pothos::is_convertible<D*,B*>::value));
};

#define POTHOS_BROKEN_IS_BASE_AND_DERIVED
...
struct is_base_and_derived_impl
{
    ...
    typedef is_base_and_derived_select<
       ::Pothos::is_class<B>::value,
       ::Pothos::is_class<D>::value,
       ::Pothos::is_same<ncvB,ncvD>::value> selector;
    typedef typename selector::template rebind<ncvB,ncvD> binder;
    typedef typename binder::type bound_type;

    POTHOS_STATIC_CONSTANT(bool, value = bound_type::value);
};
#else
template <typename B, typename D>
struct is_base_and_derived_impl
{
    ...
    POTHOS_STATIC_CONSTANT(bool, value = (POTHOS_IS_BASE_OF(B,D) && ! ::Pothos::is_same<ncvB,ncvD>::value));
};
#endif
} // namespace detail
...
POTHOS_TT_AUX_BOOL_TRAIT_DEF2(
    ...
    , Base
    , Derived
    , (::Pothos::detail::is_base_and_derived_impl<Base,Derived>::value)
    )

#ifndef POTHOS_NO_TEMPLATE_PARTIAL_SPECIALIZATION
POTHOS_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC2_2(typename Base,typename Derived,is_base_and_derived,Base&,Derived,false)
POTHOS_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC2_2(typename Base,typename Derived,is_base_and_derived,Base,Derived&,false)
POTHOS_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC2_2(typename Base,typename Derived,is_base_and_derived,Base&,Derived&,false)
#endif

#if POTHOS_WORKAROUND(__CODEGEARC__, POTHOS_TESTED_AT(0x610))
POTHOS_TT_AUX_BOOL_TRAIT_PARTIAL_SPEC2_1(typename Base,is_base_and_derived,Base,Base,false)
#endif

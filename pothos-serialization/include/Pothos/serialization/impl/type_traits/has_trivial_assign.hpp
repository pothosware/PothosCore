...
#ifndef POTHOS_TT_HAS_TRIVIAL_ASSIGN_HPP_INCLUDED
#define POTHOS_TT_HAS_TRIVIAL_ASSIGN_HPP_INCLUDED
...
{
#ifdef POTHOS_HAS_TRIVIAL_ASSIGN
   POTHOS_STATIC_CONSTANT(bool, value = POTHOS_HAS_TRIVIAL_ASSIGN(T));
#else
   POTHOS_STATIC_CONSTANT(bool, value =
      (::Pothos::type_traits::ice_and<
        ::Pothos::is_pod<T>::value,
        ::Pothos::type_traits::ice_not< ::Pothos::is_const<T>::value >::value,
...
POTHOS_TT_AUX_BOOL_TRAIT_DEF1(has_trivial_assign,T,::Pothos::detail::has_trivial_assign_impl<T>::value)
POTHOS_TT_AUX_BOOL_TRAIT_SPEC1(has_trivial_assign,void,false)
#ifndef POTHOS_NO_CV_VOID_SPECIALIZATIONS
POTHOS_TT_AUX_BOOL_TRAIT_SPEC1(has_trivial_assign,void const,false)
POTHOS_TT_AUX_BOOL_TRAIT_SPEC1(has_trivial_assign,void const volatile,false)
POTHOS_TT_AUX_BOOL_TRAIT_SPEC1(has_trivial_assign,void volatile,false)
#endif

...
#ifndef POTHOS_TT_DETAIL_IS_MEM_FUN_POINTER_TESTER_HPP_INCLUDED
#define POTHOS_TT_DETAIL_IS_MEM_FUN_POINTER_TESTER_HPP_INCLUDED
...
no_type POTHOS_TT_DECL is_mem_fun_pointer_tester(...);
...
yes_type is_mem_fun_pointer_tester(R (T::*const volatile*)(POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,T)));

template <class R, class T POTHOS_PP_COMMA_IF(POTHOS_PP_COUNTER) POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (T::*const volatile*)(POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,T)) const);

template <class R, class T POTHOS_PP_COMMA_IF(POTHOS_PP_COUNTER) POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (T::*const volatile*)(POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,T)) volatile);

template <class R, class T POTHOS_PP_COMMA_IF(POTHOS_PP_COUNTER) POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (T::*const volatile*)(POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,T)) const volatile);
...
yes_type is_mem_fun_pointer_tester(R (T::*const volatile*)(POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,T) ...) const volatile);
@#endif
@#ifdef POTHOS_TT_TEST_MS_FUNC_SIGS // Other calling conventions used by MS compatible compilers:
template <class R, class T POTHOS_PP_COMMA_IF(POTHOS_PP_COUNTER) POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__stdcall T::*const volatile*)(POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,T)));

template <class R, class T POTHOS_PP_COMMA_IF(POTHOS_PP_COUNTER) POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__stdcall T::*const volatile*)(POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,T)) const);

template <class R, class T POTHOS_PP_COMMA_IF(POTHOS_PP_COUNTER) POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__stdcall T::*const volatile*)(POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,T)) volatile);

template <class R, class T POTHOS_PP_COMMA_IF(POTHOS_PP_COUNTER) POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__stdcall T::*const volatile*)(POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,T)) const volatile);
...
@#ifndef _MANAGED
template <class R, class T POTHOS_PP_COMMA_IF(POTHOS_PP_COUNTER) POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__fastcall T::*const volatile*)(POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,T)));

template <class R, class T POTHOS_PP_COMMA_IF(POTHOS_PP_COUNTER) POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__fastcall T::*const volatile*)(POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,T)) const);

template <class R, class T POTHOS_PP_COMMA_IF(POTHOS_PP_COUNTER) POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__fastcall T::*const volatile*)(POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,T)) volatile);

template <class R, class T POTHOS_PP_COMMA_IF(POTHOS_PP_COUNTER) POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__fastcall T::*const volatile*)(POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,T)) const volatile);
...
template <class R, class T POTHOS_PP_COMMA_IF(POTHOS_PP_COUNTER) POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__cdecl T::*const volatile*)(POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,T)));

template <class R, class T POTHOS_PP_COMMA_IF(POTHOS_PP_COUNTER) POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__cdecl T::*const volatile*)(POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,T)) const);

template <class R, class T POTHOS_PP_COMMA_IF(POTHOS_PP_COUNTER) POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__cdecl T::*const volatile*)(POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,T)) volatile);

template <class R, class T POTHOS_PP_COMMA_IF(POTHOS_PP_COUNTER) POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,class T) >
yes_type is_mem_fun_pointer_tester(R (__cdecl T::*const volatile*)(POTHOS_PP_ENUM_PARAMS(POTHOS_PP_COUNTER,T)) const volatile);

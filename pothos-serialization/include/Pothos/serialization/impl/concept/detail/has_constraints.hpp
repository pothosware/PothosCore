...
#ifndef POTHOS_CONCEPT_DETAIL_HAS_CONSTRAINTS_DWA2006429_HPP
# define POTHOS_CONCEPT_DETAIL_HAS_CONSTRAINTS_DWA2006429_HPP
...
#if POTHOS_WORKAROUND(__SUNPRO_CC, <= 0x580) || defined(__CUDACC__)

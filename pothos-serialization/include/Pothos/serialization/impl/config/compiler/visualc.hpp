...
#  define POTHOS_MSVC_FULL_VER _MSC_FULL_VER
#else
#  define POTHOS_MSVC_FULL_VER (_MSC_FULL_VER * 10)
#endif
...
#if !defined(_WIN32_WCE) && !defined(UNDER_CE)
#  define POTHOS_HAS_THREADEX
#  define POTHOS_HAS_GETSYSTEMTIMEASFILETIME
#endif

//
// check for exception handling support:
#if !defined(_CPPUNWIND) && !defined(POTHOS_NO_EXCEPTIONS)
...
// turned off:
//
#if !defined(_MSC_EXTENSIONS) && !defined(POTHOS_DISABLE_WIN32)
#  define POTHOS_DISABLE_WIN32
#endif
#if !defined(_CPPRTTI) && !defined(POTHOS_NO_RTTI)
...
#  define POTHOS_ABI_PREFIX "Pothos/serialization/impl/config/abi/msvc_prefix.hpp"
#endif
#ifndef POTHOS_ABI_SUFFIX
#  define POTHOS_ABI_SUFFIX "Pothos/serialization/impl/config/abi/msvc_suffix.hpp"
#endif
...
#      endif
#   elif _MSC_VER < 1500
#     define POTHOS_COMPILER_VERSION evc8
#   elif _MSC_VER < 1600
#     define POTHOS_COMPILER_VERSION evc9
#   elif _MSC_VER < 1700
#     define POTHOS_COMPILER_VERSION evc10
#   elif _MSC_VER < 1800 
#     define POTHOS_COMPILER_VERSION evc11 
#   elif _MSC_VER < 1900 
#     define POTHOS_COMPILER_VERSION evc12
#   else
#      if defined(POTHOS_ASSERT_CONFIG)
#         error "Unknown EVC++ compiler version - please run the configure tests and report the results"
#      else
...
#     define POTHOS_COMPILER_VERSION 5.0
#   elif _MSC_VER < 1300
#     define POTHOS_COMPILER_VERSION 6.0
#   elif _MSC_VER < 1310
#     define POTHOS_COMPILER_VERSION 7.0
#   elif _MSC_VER < 1400
#     define POTHOS_COMPILER_VERSION 7.1
#   elif _MSC_VER < 1500
#     define POTHOS_COMPILER_VERSION 8.0
#   elif _MSC_VER < 1600
#     define POTHOS_COMPILER_VERSION 9.0
#   elif _MSC_VER < 1700
#     define POTHOS_COMPILER_VERSION 10.0
#   elif _MSC_VER < 1800 
#     define POTHOS_COMPILER_VERSION 11.0
#   elif _MSC_VER < 1900
#     define POTHOS_COMPILER_VERSION 12.0
#   else
#     define POTHOS_COMPILER_VERSION _MSC_VER
#   endif
# endif

#  define POTHOS_COMPILER "Microsoft Visual C++ version " POTHOS_STRINGIZE(POTHOS_COMPILER_VERSION)
#endif

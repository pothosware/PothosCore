...
#define POTHOS_GCC (__GNUC__ * 10000 + __GNUC_MINOR__ * 100 + __GNUC_PATCHLEVEL__)
#endif
...
#if !defined(__EXCEPTIONS) && !defined(POTHOS_NO_EXCEPTIONS)
...
#    define POTHOS_SYMBOL_EXPORT __attribute__((__dllexport__))
#    define POTHOS_SYMBOL_IMPORT __attribute__((__dllimport__))
#  else
...
#if !defined(POTHOS_NO_CXX11_DEFAULTED_FUNCTIONS) && (__GNUC__ == 4 && __GNUC_MINOR__ <= 5)
#  define POTHOS_NO_CXX11_NON_PUBLIC_DEFAULTED_FUNCTIONS
#endif
...
#  define POTHOS_COMPILER "GNU C++ version " __VERSION__
#endif

// ConceptGCC compiler:
//   http://www.generic-programming.org/software/ConceptGCC/
#ifdef __GXX_CONCEPTS__
#  define POTHOS_HAS_CONCEPTS
#  define POTHOS_COMPILER "ConceptGCC version " __VERSION__
#endif

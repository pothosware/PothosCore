...
#ifndef POTHOS_ALIGNED_STORAGE_HPP
#define POTHOS_ALIGNED_STORAGE_HPP
...
POTHOS_STATIC_CONSTANT(
      std::size_t
    , alignment_of_max_align = ::Pothos::alignment_of<max_align>::value
    );
...
public: // constants
    ...
    POTHOS_STATIC_CONSTANT(
        ...
        , alignment = (
              alignment_ == std::size_t(-1)
            ? ::Pothos::detail::aligned_storage::alignment_of_max_align
            : alignment_
            )
        );
...
struct is_pod<Pothos::detail::aligned_storage::aligned_storage_imp<size_,alignment_> >
   POTHOS_TT_AUX_BOOL_C_BASE(true)
{ 
    POTHOS_TT_AUX_BOOL_TRAIT_VALUE_DECL(true)
}; 
#endif

...
#ifndef POTHOS_RANGE_DETAIL_REMOVE_BOUNDS_HPP
#define POTHOS_RANGE_DETAIL_REMOVE_BOUNDS_HPP

#include <Pothos/serialization/impl/config.hpp>  // MSVC, NO_INTRINSIC_WCHAR_T, put size_t in std.
#include <cstddef>
...
namespace Pothos 
{
    namespace range_detail
    {
        ...
        struct remove_extent {
            static T* ar;
            POTHOS_STATIC_CONSTANT(std::size_t, size = sizeof(*ar) / sizeof((*ar)[0]));

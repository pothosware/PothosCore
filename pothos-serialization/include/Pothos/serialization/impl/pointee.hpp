...
# include <Pothos/serialization/impl/detail/is_incrementable.hpp>
...
namespace detail
{
  ...
  struct iterator_pointee
  {
      ...
      POTHOS_STATIC_CONSTANT(bool, is_constant = sizeof(impl::test(*impl::x)) == 1);
      
      typedef typename mpl::if_c<
#  if POTHOS_WORKAROUND(__BORLANDC__, POTHOS_TESTED_AT(0x551))
          ::Pothos::detail::iterator_pointee<Iterator>::is_constant
#  else
          is_constant
#  endif 

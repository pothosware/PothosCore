#ifndef POTHOS_ARCHIVE_DETAIL_AUTO_LINK_WARCHIVE_HPP
#define POTHOS_ARCHIVE_DETAIL_AUTO_LINK_WARCHIVE_HPP
...
&& !defined(POTHOS_ALL_NO_LIB) && !defined(POTHOS_SERIALIZATION_NO_LIB)

// Set the name of our library, this will get undef'ed by auto_link.hpp
// once it's done with it:
//
#define POTHOS_LIB_NAME Pothos_wserialization
//

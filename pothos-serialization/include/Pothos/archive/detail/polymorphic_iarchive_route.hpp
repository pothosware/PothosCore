#ifndef POTHOS_ARCHIVE_DETAIL_POLYMORPHIC_IARCHIVE_ROUTE_HPP
#define POTHOS_ARCHIVE_DETAIL_POLYMORPHIC_IARCHIVE_ROUTE_HPP
...
private:
    ...
    virtual void load(Pothos::long_long_type & t){
        ArchiveImplementation::load(t);
    }
    virtual void load(Pothos::ulong_long_type & t){
        ArchiveImplementation::load(t);
    }

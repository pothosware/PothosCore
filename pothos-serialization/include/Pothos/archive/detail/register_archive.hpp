...
#ifndef POTHOS_ARCHIVE_DETAIL_REGISTER_ARCHIVE_DWA2006521_HPP
# define POTHOS_ARCHIVE_DETAIL_REGISTER_ARCHIVE_DWA2006521_HPP
...
#define POTHOS_SERIALIZATION_REGISTER_ARCHIVE(Archive)                     \
namespace Pothos { namespace archive { namespace detail {                  \
...
namespace Pothos { namespace archive { namespace detail {                \
                                                                        \
template <class Serializable>                                           \
POTHOS_DEDUCED_TYPENAME _ptr_serialization_support<Archive, Serializable>::type  \

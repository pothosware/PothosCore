#ifndef  POTHOS_ARCHIVE_BASIC_SERIALIZER_HPP
#define POTHOS_ARCHIVE_BASIC_SERIALIZER_HPP
...
public:
    ...
    const Pothos::serialization::extended_type_info & get_eti() const {
        return * m_eti;
    }
};

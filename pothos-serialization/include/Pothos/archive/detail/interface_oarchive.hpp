#ifndef POTHOS_ARCHIVE_DETAIL_INTERFACE_OARCHIVE_HPP
#define POTHOS_ARCHIVE_DETAIL_INTERFACE_OARCHIVE_HPP
...
class POTHOS_ARCHIVE_OR_WARCHIVE_DECL(POTHOS_PP_EMPTY()) basic_pointer_oserializer;

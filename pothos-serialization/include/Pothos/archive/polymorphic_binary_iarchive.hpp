#ifndef POTHOS_ARCHIVE_POLYMORPHIC_BINARY_IARCHIVE_HPP
#define POTHOS_ARCHIVE_POLYMORPHIC_BINARY_IARCHIVE_HPP
...
#include <Pothos/archive/binary_iarchive.hpp>
...
POTHOS_SERIALIZATION_REGISTER_ARCHIVE(
    Pothos::archive::polymorphic_binary_iarchive
)

#ifndef POTHOS_ARCHIVE_POLYMORPHIC_IARCHIVE_HPP
#define POTHOS_ARCHIVE_POLYMORPHIC_IARCHIVE_HPP
...
#include <Pothos/archive/detail/interface_iarchive.hpp>
...
public:
    ...
    virtual void load(Pothos::long_long_type & t) = 0;
    virtual void load(Pothos::ulong_long_type & t) = 0;
...
// required by export
POTHOS_SERIALIZATION_REGISTER_ARCHIVE(Pothos::archive::polymorphic_iarchive)

#ifndef POTHOS_ARCHIVE_ARCHIVE_EXCEPTION_HPP
#define POTHOS_ARCHIVE_ARCHIVE_EXCEPTION_HPP
...
//
class POTHOS_ARCHIVE_DECL(POTHOS_PP_EMPTY()) archive_exception : 

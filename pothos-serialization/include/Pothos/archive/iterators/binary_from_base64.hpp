#ifndef POTHOS_ARCHIVE_ITERATORS_BINARY_FROM_BASE64_HPP
#define POTHOS_ARCHIVE_ITERATORS_BINARY_FROM_BASE64_HPP
...
struct to_6_bit {
    ...
    CharType operator()(CharType t) const{
        ...
        POTHOS_STATIC_ASSERT(128 == sizeof(lookup_table));
        #endif
        signed char value = -1;
        if((unsigned)t <= 127)
...
public:
    ...
    template<class T>
    binary_from_base64(POTHOS_PFTO_WRAPPER(T)  start) :
        super_t(

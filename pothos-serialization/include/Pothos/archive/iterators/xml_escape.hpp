#ifndef POTHOS_ARCHIVE_ITERATORS_XML_ESCAPE_HPP
#define POTHOS_ARCHIVE_ITERATORS_XML_ESCAPE_HPP
...
#include <Pothos/archive/iterators/escape.hpp>
...
public:
    ...
    template<class T>
    xml_escape(POTHOS_PFTO_WRAPPER(T) start) :

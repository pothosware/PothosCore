#ifndef POTHOS_ARCHIVE_ITERATORS_BASE64_FROM_BINARY_HPP
#define POTHOS_ARCHIVE_ITERATORS_BASE64_FROM_BINARY_HPP
...
#include <Pothos/serialization/impl/iterator/transform_iterator.hpp>
...
template<
    class Base, 
    class CharType = POTHOS_DEDUCED_TYPENAME Pothos::iterator_value<Base>::type
>
    ...
    >
{
    ...
    typedef transform_iterator<
        POTHOS_DEDUCED_TYPENAME detail::from_6_bit<CharType>,
        Base
    > super_t;
...
public:
    ...
    template<class T>
    base64_from_binary(POTHOS_PFTO_WRAPPER(T) start) :
        super_t(
            Base(POTHOS_MAKE_PFTO_WRAPPER(static_cast< T >(start))),
            detail::from_6_bit<CharType>()
        )
    {}

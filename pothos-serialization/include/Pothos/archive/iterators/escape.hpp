#ifndef POTHOS_ARCHIVE_ITERATORS_ESCAPE_HPP
#define POTHOS_ARCHIVE_ITERATORS_ESCAPE_HPP
...
class escape : 
    ...
    >
{
    typedef POTHOS_DEDUCED_TYPENAME Pothos::iterator_value<Base>::type base_value_type;
    typedef POTHOS_DEDUCED_TYPENAME Pothos::iterator_reference<Base>::type reference_type;

#ifndef POTHOS_ARCHIVE_ITERATORS_INSERT_LINEBREAKS_HPP
#define POTHOS_ARCHIVE_ITERATORS_INSERT_LINEBREAKS_HPP
...
public:
    ...
    template<class T>
    insert_linebreaks(POTHOS_PFTO_WRAPPER(T)  start) :

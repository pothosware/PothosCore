#ifndef POTHOS_ARCHIVE_POLYMORPHIC_TEXT_IARCHIVE_HPP
#define POTHOS_ARCHIVE_POLYMORPHIC_TEXT_IARCHIVE_HPP
...
#include <Pothos/archive/text_iarchive.hpp>
...
POTHOS_SERIALIZATION_REGISTER_ARCHIVE(
    Pothos::archive::polymorphic_text_iarchive
)

#ifndef POTHOS_ARCHIVE_POLYMORPHIC_TEXT_OARCHIVE_HPP
#define POTHOS_ARCHIVE_POLYMORPHIC_TEXT_OARCHIVE_HPP
...
#include <Pothos/archive/text_oarchive.hpp>
...
POTHOS_SERIALIZATION_REGISTER_ARCHIVE(
    Pothos::archive::polymorphic_text_oarchive
)

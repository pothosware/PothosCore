#ifndef POTHOS_ARCHIVE_BASIC_ARCHIVE_HPP
#define POTHOS_ARCHIVE_BASIC_ARCHIVE_HPP
...
#include <Pothos/serialization/impl/cstdint.hpp> // size_t
...
POTHOS_ARCHIVE_DECL(library_version_type)
POTHOS_ARCHIVE_VERSION();
...
#define NULL_POINTER_TAG Pothos::archive::class_id_type(-1)
...
#define POTHOS_ARCHIVE_STRONG_TYPEDEF(T, D)         \
    class D : public T {                           \
    public:                                        \
...
POTHOS_ARCHIVE_STRONG_TYPEDEF(class_id_type, class_id_reference_type)
POTHOS_ARCHIVE_STRONG_TYPEDEF(class_id_type, class_id_optional_type)
POTHOS_ARCHIVE_STRONG_TYPEDEF(object_id_type, object_reference_type)
...
POTHOS_CLASS_IMPLEMENTATION(Pothos::archive::library_version_type, primitive_type)
POTHOS_CLASS_IMPLEMENTATION(Pothos::archive::version_type, primitive_type)
POTHOS_CLASS_IMPLEMENTATION(Pothos::archive::class_id_type, primitive_type)
POTHOS_CLASS_IMPLEMENTATION(Pothos::archive::class_id_reference_type, primitive_type)
POTHOS_CLASS_IMPLEMENTATION(Pothos::archive::class_id_optional_type, primitive_type)
POTHOS_CLASS_IMPLEMENTATION(Pothos::archive::class_name_type, primitive_type)
POTHOS_CLASS_IMPLEMENTATION(Pothos::archive::object_id_type, primitive_type)
POTHOS_CLASS_IMPLEMENTATION(Pothos::archive::object_reference_type, primitive_type)
POTHOS_CLASS_IMPLEMENTATION(Pothos::archive::tracking_type, primitive_type)
...
POTHOS_IS_BITWISE_SERIALIZABLE(Pothos::archive::library_version_type)
POTHOS_IS_BITWISE_SERIALIZABLE(Pothos::archive::version_type)
POTHOS_IS_BITWISE_SERIALIZABLE(Pothos::archive::class_id_type)
POTHOS_IS_BITWISE_SERIALIZABLE(Pothos::archive::class_id_reference_type)
POTHOS_IS_BITWISE_SERIALIZABLE(Pothos::archive::class_id_optional_type)
POTHOS_IS_BITWISE_SERIALIZABLE(Pothos::archive::class_name_type)
POTHOS_IS_BITWISE_SERIALIZABLE(Pothos::archive::object_id_type)
POTHOS_IS_BITWISE_SERIALIZABLE(Pothos::archive::object_reference_type)
POTHOS_IS_BITWISE_SERIALIZABLE(Pothos::archive::tracking_type)

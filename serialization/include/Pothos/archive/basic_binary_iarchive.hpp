#ifndef POTHOS_ARCHIVE_BASIC_BINARY_IARCHIVE_HPP
#define POTHOS_ARCHIVE_BASIC_BINARY_IARCHIVE_HPP
...
#include <Pothos/archive/detail/common_iarchive.hpp>
...
public:
    ...
    template<class T>
    void load_override(T & t, POTHOS_PFTO int version){
    ...
    void load_override(tracking_type & t, int /*version*/){
        ...
        if(Pothos::archive::library_version_type(6) < lvt){
            int_least8_t x=0;
            * this->This() >> x;
            t = Pothos::archive::tracking_type(x);
        }
        else{
            bool x=0;
            * this->This() >> x;
    ...
    void load_override(class_id_type & t, int version){
        ...
        if(Pothos::archive::library_version_type(6) < lvt){
            int_least16_t x=0;
            * this->This() >> x;
            t = Pothos::archive::class_id_type(x);
        }
        else{
            int x=0;
            * this->This() >> x;
    ...
    void load_override(class_id_reference_type & t, int version){
        ...
        if(Pothos::archive::library_version_type(6) < lvt){
            int_least16_t x=0;
            * this->This() >> x;
            t = Pothos::archive::class_id_reference_type(
                Pothos::archive::class_id_type(x)
            );
        }
        else{
            int x=0;
    ...
    void load_override(version_type & t, int version){
        ...
        if(Pothos::archive::library_version_type(6) < lvt){
            uint_least8_t x=0;
            * this->This() >> x;
            t = Pothos::archive::version_type(x);
        }
        else
        if(Pothos::archive::library_version_type(5) < lvt){
            uint_least16_t x=0;
            * this->This() >> x;
            t = Pothos::archive::version_type(x);
        }
        else
        if(Pothos::archive::library_version_type(2) < lvt){
            // upto 255 versions
            unsigned char x=0;
            * this->This() >> x;
            t = version_type(x);
    ...
    void load_override(Pothos::serialization::item_version_type & t, int version){
        library_version_type lvt = this->get_library_version();
//        if(boost::archive::library_version_type(7) < lvt){
        ...
        if(Pothos::archive::library_version_type(6) < lvt){
            uint_least16_t x=0;
            * this->This() >> x;
            t = Pothos::serialization::item_version_type(x);
        }
        else{
            unsigned int x=0;
            * this->This() >> x;
    ...
    void load_override(serialization::collection_size_type & t, int version){
        if(Pothos::archive::library_version_type(5) < this->get_library_version()){
            this->detail_common_iarchive::load_override(t, version);
        }
        else{
            unsigned int x=0;

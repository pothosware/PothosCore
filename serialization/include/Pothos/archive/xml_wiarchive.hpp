#ifndef POTHOS_ARCHIVE_XML_WIARCHIVE_HPP
#define POTHOS_ARCHIVE_XML_WIARCHIVE_HPP
...
protected:
    ...
    void 
    load(Pothos::serialization::item_version_type & t){
        unsigned int v;
        load(v);
...
// required by export
POTHOS_SERIALIZATION_REGISTER_ARCHIVE(Pothos::archive::xml_wiarchive)

#ifndef POTHOS_ARCHIVE_POLYMORPHIC_TEXT_WIARCHIVE_HPP
#define POTHOS_ARCHIVE_POLYMORPHIC_TEXT_WIARCHIVE_HPP
...
#include <Pothos/archive/text_wiarchive.hpp>
...
POTHOS_SERIALIZATION_REGISTER_ARCHIVE(
    Pothos::archive::polymorphic_text_wiarchive
)

#ifndef POTHOS_ARCHIVE_BINARY_WIARCHIVE_HPP
#define POTHOS_ARCHIVE_BINARY_WIARCHIVE_HPP
...
class naked_binary_wiarchive : 
    public binary_iarchive_impl<
        Pothos::archive::naked_binary_wiarchive, 
...
// required by export
POTHOS_SERIALIZATION_REGISTER_ARCHIVE(Pothos::archive::binary_wiarchive)

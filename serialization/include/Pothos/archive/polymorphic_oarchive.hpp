#ifndef POTHOS_ARCHIVE_POLYMORPHIC_OARCHIVE_HPP
#define POTHOS_ARCHIVE_POLYMORPHIC_OARCHIVE_HPP
...
#include <Pothos/archive/detail/oserializer.hpp>
#include <Pothos/archive/detail/interface_oarchive.hpp>
...
public:
    ...
    virtual void save(const Pothos::long_long_type t) = 0;
    virtual void save(const Pothos::ulong_long_type t) = 0;
    ...
    void save_override(
                ...
                const
                #endif
                ::Pothos::serialization::nvp< T > & t, int
        ){
        save_start(t.name());
...
// required by export
POTHOS_SERIALIZATION_REGISTER_ARCHIVE(Pothos::archive::polymorphic_oarchive)

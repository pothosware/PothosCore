#ifndef POTHOS_ARCHIVE_BINARY_WOARCHIVE_HPP
#define POTHOS_ARCHIVE_BINARY_WOARCHIVE_HPP
...
// required by export
POTHOS_SERIALIZATION_REGISTER_ARCHIVE(Pothos::archive::binary_woarchive)

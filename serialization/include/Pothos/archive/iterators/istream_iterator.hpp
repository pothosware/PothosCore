#ifndef POTHOS_ARCHIVE_ITERATORS_ISTREAM_ITERATOR_HPP
#define POTHOS_ARCHIVE_ITERATORS_ISTREAM_ITERATOR_HPP
    ...
    >
{
    ...
    typedef POTHOS_DEDUCED_TYPENAME Pothos::iterator_facade<
        istream_iterator<Elem>,
        Elem,
        std::input_iterator_tag,
        Elem
    > super_t;
    typedef POTHOS_DEDUCED_TYPENAME std::basic_istream<Elem> istream_type;

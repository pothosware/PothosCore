#ifndef POTHOS_ARCHIVE_ITERATORS_MB_FROM_WCHAR_HPP
#define POTHOS_ARCHIVE_ITERATORS_MB_FROM_WCHAR_HPP
    ...
    >
{
    ...
    void fill(){
        ...
        #endif
        POTHOS_ASSERT(-1 != m_bend);
        POTHOS_ASSERT((std::size_t)m_bend <= sizeof(m_buffer));
        POTHOS_ASSERT(m_bend > 0);
        m_bnext = 0;
    }
...
public:
    ...
    template<class T>
    mb_from_wchar(POTHOS_PFTO_WRAPPER(T) start) :

#ifndef POTHOS_ARCHIVE_ITERATORS_WCHAR_FROM_MB_HPP
#define POTHOS_ARCHIVE_ITERATORS_WCHAR_FROM_MB_HPP
...
public:
    ...
    template<class T>
    wchar_from_mb(POTHOS_PFTO_WRAPPER(T) start) : 
...
wchar_t wchar_from_mb<Base>::drain(){
    ...
    if(0 >= result)
        Pothos::serialization::throw_exception(iterators::dataflow_exception(

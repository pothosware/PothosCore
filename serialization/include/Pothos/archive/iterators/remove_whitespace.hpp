#ifndef POTHOS_ARCHIVE_ITERATORS_REMOVE_WHITESPACE_HPP
#define POTHOS_ARCHIVE_ITERATORS_REMOVE_WHITESPACE_HPP
...
#include <Pothos/serialization/impl/iterator/filter_iterator.hpp>
    ...
    >
{
    ...
    typedef POTHOS_DEDUCED_TYPENAME super_t::reference reference_type;
...
class remove_whitespace : 
    public filter_iterator<
        remove_whitespace_predicate<
            POTHOS_DEDUCED_TYPENAME Pothos::iterator_value<Base>::type
...
//    remove_whitespace(){} // why is this needed?
    ...
    template<class T>
    remove_whitespace(POTHOS_PFTO_WRAPPER(T) start) :

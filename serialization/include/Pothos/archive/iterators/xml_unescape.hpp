#ifndef POTHOS_ARCHIVE_ITERATORS_XML_UNESCAPE_HPP
#define POTHOS_ARCHIVE_ITERATORS_XML_UNESCAPE_HPP
...
#include <Pothos/archive/iterators/unescape.hpp>
    ...
    : public unescape<xml_unescape<Base>, Base>
{
    ...
    typedef POTHOS_DEDUCED_TYPENAME Pothos::iterator_reference<this_t> reference_type;
...
public:
    ...
    #else
        typedef POTHOS_DEDUCED_TYPENAME this_t::value_type value_type;
    #endif
    ...
    template<class T>
    xml_unescape(POTHOS_PFTO_WRAPPER(T) start) : 
...
template<class Base>
POTHOS_DEDUCED_TYPENAME xml_unescape<Base>::value_type 
//int 

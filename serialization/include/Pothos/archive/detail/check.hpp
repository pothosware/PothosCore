#ifndef POTHOS_ARCHIVE_DETAIL_CHECK_HPP
#define POTHOS_ARCHIVE_DETAIL_CHECK_HPP
...
inline void check_object_level(){
    typedef 
        POTHOS_DEDUCED_TYPENAME mpl::greater_equal<
    ...
    // not_serializable
    POTHOS_STATIC_ASSERT(typex::value);
}

template<class T>
inline void check_object_versioning(){
    typedef 
        POTHOS_DEDUCED_TYPENAME mpl::or_<
            POTHOS_DEDUCED_TYPENAME mpl::greater<
                serialization::implementation_level< T >,
...
inline void check_object_tracking(){
    ...
    // T is not a const
    POTHOS_STATIC_ASSERT(! Pothos::is_const< T >::value);
    typedef POTHOS_DEDUCED_TYPENAME mpl::equal_to<
    ...
    POTHOS_STATIC_WARNING(typex::value);
}
    ...
    typedef 
        POTHOS_DEDUCED_TYPENAME mpl::or_<
            POTHOS_DEDUCED_TYPENAME mpl::greater<
                ...
                mpl::int_<serialization::object_serializable>
            >,
            POTHOS_DEDUCED_TYPENAME mpl::not_<
                POTHOS_DEDUCED_TYPENAME mpl::equal_to<
                    serialization::tracking_level< T >,
...
void inline check_pointer_tracking(){
    typedef POTHOS_DEDUCED_TYPENAME mpl::greater<
        serialization::tracking_level< T >,
        mpl::int_<serialization::track_never>
    >::type typex;
...
inline void check_const_loading(){
    typedef
        POTHOS_DEDUCED_TYPENAME mpl::or_<
            POTHOS_DEDUCED_TYPENAME Pothos::serialization::is_wrapper< T >,
            POTHOS_DEDUCED_TYPENAME mpl::not_<
                POTHOS_DEDUCED_TYPENAME Pothos::is_const< T >
            >
        >::type typex;

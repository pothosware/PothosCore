#ifndef POTHOS_ARCHIVE_BASIC_OARCHIVE_HPP
#define POTHOS_ARCHIVE_BASIC_OARCHIVE_HPP
...
class POTHOS_ARCHIVE_OR_WARCHIVE_DECL(POTHOS_PP_EMPTY()) basic_oarchive :
...
POTHOS_TT_BROKEN_COMPILER_SPEC(
    Pothos::archive::detail::basic_oarchive
)

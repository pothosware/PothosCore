#ifndef POTHOS_ARCHIVE_DETAIL_POLYMORPHIC_OARCHIVE_ROUTE_HPP
#define POTHOS_ARCHIVE_DETAIL_POLYMORPHIC_OARCHIVE_ROUTE_HPP
...
private:
    ...
    virtual void save(const Pothos::long_long_type t){
        ArchiveImplementation::save(t);
    }
    virtual void save(const Pothos::ulong_long_type t){
        ArchiveImplementation::save(t);
    }
    #elif defined(POTHOS_HAS_MS_INT64)
    virtual void save(const Pothos::int64_t t){
        ArchiveImplementation::save(t);
    }
    virtual void save(const Pothos::uint64_t t){
        ArchiveImplementation::save(t);
    }
    #endif

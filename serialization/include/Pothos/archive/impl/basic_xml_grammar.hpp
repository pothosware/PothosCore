#ifndef POTHOS_ARCHIVE_BASIC_XML_GRAMMAR_HPP
#define POTHOS_ARCHIVE_BASIC_XML_GRAMMAR_HPP
...
#include <Pothos/serialization/impl/spirit/include/classic_rule.hpp>
#include <Pothos/serialization/impl/spirit/include/classic_chset.hpp>
...
private:
    typedef POTHOS_DEDUCED_TYPENAME std::basic_istream<CharType> IStream;
    typedef POTHOS_DEDUCED_TYPENAME std::basic_string<CharType> StringType;
    typedef POTHOS_DEDUCED_TYPENAME Pothos::spirit::classic::chset<CharType> chset_t;
    typedef POTHOS_DEDUCED_TYPENAME Pothos::spirit::classic::chlit<CharType> chlit_t;
    typedef POTHOS_DEDUCED_TYPENAME Pothos::spirit::classic::scanner<
        POTHOS_DEDUCED_TYPENAME  std::basic_string<CharType>::iterator
    > scanner_t;
    typedef POTHOS_DEDUCED_TYPENAME Pothos::spirit::classic::rule<scanner_t> rule_t;

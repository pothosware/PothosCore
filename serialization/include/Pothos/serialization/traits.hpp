#ifndef POTHOS_SERIALIZATION_TRAITS_HPP
#define POTHOS_SERIALIZATION_TRAITS_HPP
...
struct traits : public basic_traits {
    POTHOS_STATIC_ASSERT(Version == 0 || Level >= object_class_info);
    POTHOS_STATIC_ASSERT(Tracking == track_never || Level >= object_serializable);
    typedef POTHOS_DEDUCED_TYPENAME mpl::int_<Level> level;
    typedef POTHOS_DEDUCED_TYPENAME mpl::int_<Tracking> tracking;
    typedef POTHOS_DEDUCED_TYPENAME mpl::int_<Version> version;

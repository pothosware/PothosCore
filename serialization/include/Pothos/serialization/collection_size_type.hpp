#ifndef POTHOS_SERIALIZATION_COLLECTION_SIZE_TYPE_HPP
#define POTHOS_SERIALIZATION_COLLECTION_SIZE_TYPE_HPP
...
#include <Pothos/serialization/strong_typedef.hpp>
...
POTHOS_CLASS_IMPLEMENTATION(collection_size_type, primitive_type)
POTHOS_IS_BITWISE_SERIALIZABLE(collection_size_type)

#ifndef POTHOS_DETAIL_SHARED_PTR_NMT_132_HPP_INCLUDED
#define POTHOS_DETAIL_SHARED_PTR_NMT_132_HPP_INCLUDED
...
#include <Pothos/serialization/impl/detail/atomic_count.hpp>

#ifndef POTHOS_SERIALIZATION_STATIC_WARNING_HPP
#define POTHOS_SERIALIZATION_STATIC_WARNING_HPP
...
#include <Pothos/serialization/impl/mpl/print.hpp>
...
template<int L> 
struct POTHOS_SERIALIZATION_STATIC_WARNING_LINE{};

template<bool B, int L>
struct static_warning_test{
    typename Pothos::mpl::eval_if_c<
        B,
        Pothos::mpl::true_,
        typename Pothos::mpl::identity<
            Pothos::mpl::print<
                POTHOS_SERIALIZATION_STATIC_WARNING_LINE<L>
            >
        >
    >::type type;
};
...
template<int i>
struct POTHOS_SERIALIZATION_SS {};

} // serialization
} // boost

#define POTHOS_SERIALIZATION_BSW(B, L) \
    typedef Pothos::serialization::POTHOS_SERIALIZATION_SS< \
        sizeof( Pothos::serialization::static_warning_test< B, L > ) \
    > POTHOS_JOIN(STATIC_WARNING_LINE, L);

#define POTHOS_STATIC_WARNING(B) POTHOS_SERIALIZATION_BSW(B, __LINE__)

#ifndef  POTHOS_SERIALIZATION_MAP_HPP
#define POTHOS_SERIALIZATION_MAP_HPP
...
inline void load(
    ...
    Pothos::serialization::stl::load_collection<
        Archive,
        std::map<Key, Type, Compare, Allocator>,
        Pothos::serialization::stl::archive_input_map<
            Archive, std::map<Key, Type, Compare, Allocator> >,
            Pothos::serialization::stl::no_reserve_imp<std::map<

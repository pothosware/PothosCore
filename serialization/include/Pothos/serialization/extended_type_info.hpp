#ifndef POTHOS_SERIALIZATION_EXTENDED_TYPE_INFO_HPP
#define POTHOS_SERIALIZATION_EXTENDED_TYPE_INFO_HPP
...
#define POTHOS_SERIALIZATION_MAX_KEY_SIZE 128
...
class POTHOS_SERIALIZATION_DECL(POTHOS_PP_EMPTY()) extended_type_info :
    private Pothos::noncopyable
{
private:
    friend class Pothos::serialization::void_cast_detail::void_caster;
...
template<class T>
struct guid_defined : Pothos::mpl::false_ {};

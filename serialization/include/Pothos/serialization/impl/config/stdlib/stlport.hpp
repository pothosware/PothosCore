...
#  if !(_STLPORT_VERSION >= 0x500) && !defined(_STLP_OWN_IOSTREAMS) && defined(_STLP_USE_NAMESPACES) && defined(POTHOS_NO_USING_TEMPLATE) && !defined(__BORLANDC__)
#     define POTHOS_NO_STD_LOCALE
#  endif
#else
#  if !defined(__SGI_STL_OWN_IOSTREAMS) && defined(__STL_USE_NAMESPACES) && defined(POTHOS_NO_USING_TEMPLATE) && !defined(__BORLANDC__)
#     define POTHOS_NO_STD_LOCALE
#  endif
#endif
...
#if defined(_STLP_NO_MEMBER_TEMPLATE_KEYWORD) && defined(POTHOS_MSVC) && (POTHOS_MSVC <= 1300)
#  define POTHOS_NO_STD_ALLOCATOR
#endif
...
#     define POTHOS_NO_EXCEPTION_STD_NAMESPACE
#  endif
...
#  define POTHOS_HAS_STLP_USE_FACET
#endif
...
// into std:: ourselves).
//
#if defined(_STLP_NO_NATIVE_WIDE_FUNCTIONS) && !defined(POTHOS_NO_STDC_NAMESPACE)
...
//
#if !defined( _STLP_HAS_WCHAR_T) || defined(_STLP_WCHAR_T_IS_USHORT)
#  undef  POTHOS_NO_INTRINSIC_WCHAR_T
...
#  define POTHOS_USING_STD_MIN() ((void)0)
#  define POTHOS_USING_STD_MAX() ((void)0)
namespace Pothos { using std::min; using std::max; }
#endif
...
#define POTHOS_STDLIB "STLPort standard library version " POTHOS_STRINGIZE(__SGI_STL_PORT)

...
//
#ifndef _RWSTD_VER
#  define POTHOS_RWSTD_VER 0x010000
#elif _RWSTD_VER < 0x010000
#  define POTHOS_RWSTD_VER (_RWSTD_VER << 8)
#else
#  define POTHOS_RWSTD_VER _RWSTD_VER
#endif

#ifndef _RWSTD_VER
#  define POTHOS_STDLIB "Rogue Wave standard library version (Unknown version)"
#elif _RWSTD_VER < 0x04010200
 #  define POTHOS_STDLIB "Rogue Wave standard library version " POTHOS_STRINGIZE(_RWSTD_VER)
#else
#  ifdef _RWSTD_VER_STR
#    define POTHOS_STDLIB "Apache STDCXX standard library version " _RWSTD_VER_STR
#  else
#    define POTHOS_STDLIB "Apache STDCXX standard library version " POTHOS_STRINGIZE(_RWSTD_VER)
#  endif
#endif
...
// template do:
//
#if POTHOS_RWSTD_VER < 0x020200
#  define POTHOS_NO_LIMITS_COMPILE_TIME_CONSTANTS
#endif

// Sun CC 5.5 patch 113817-07 adds long long specialization, but does not change the
// library version number (http://sunsolve6.sun.com/search/document.do?assetkey=1-21-113817):
#if POTHOS_RWSTD_VER <= 0x020101 && (!defined(__SUNPRO_CC) || (__SUNPRO_CC < 0x550))
...
//
#if defined(_RWSTD_NO_SIMPLE_DEFAULT_TEMPLATES) || defined(RWSTD_NO_SIMPLE_DEFAULT_TEMPLATES) || (POTHOS_RWSTD_VER < 0x020000)
#  define POTHOS_NO_STD_ITERATOR
#endif
...
//
#if (POTHOS_RWSTD_VER < 0x020000)
#  define POTHOS_NO_AUTO_PTR
...
//
#if defined(_RWSTD_NO_TEMPLATE_ON_RETURN_TYPE) && !defined(POTHOS_NO_STD_LOCALE)
...
//
#if (POTHOS_RWSTD_VER < 0x020000) || defined(_RWSTD_NO_CLASS_PARTIAL_SPEC)
    #define POTHOS_NO_STD_DISTANCE
#endif
...
// OutputIterators:
//
#if POTHOS_RWSTD_VER < 0x020100
#  define POTHOS_NO_STD_OUTPUT_ITERATOR_ASSIGN
#endif

//
// Disable BOOST_HAS_LONG_LONG when the library has no support for it.
//
#if !defined(_RWSTD_LONG_LONG) && defined(POTHOS_HAS_LONG_LONG)
...
//
#if defined(__HP_aCC) && (POTHOS_RWSTD_VER == 0x02020100)

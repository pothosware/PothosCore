...
#ifdef __FreeBSD__
#define POTHOS_PLATFORM "FreeBSD " POTHOS_STRINGIZE(__FreeBSD__)
#elif defined(__NetBSD__)
#define POTHOS_PLATFORM "NetBSD " POTHOS_STRINGIZE(__NetBSD__)
#elif defined(__OpenBSD__)
#define POTHOS_PLATFORM "OpenBSD " POTHOS_STRINGIZE(__OpenBSD__)
#elif defined(__DragonFly__)
#define POTHOS_PLATFORM "DragonFly " POTHOS_STRINGIZE(__DragonFly__)
#endif
...
#  define POTHOS_NO_CTYPE_FUNCTIONS
#endif

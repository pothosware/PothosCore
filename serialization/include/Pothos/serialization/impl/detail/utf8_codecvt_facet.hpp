...
#ifndef POTHOS_UTF8_CODECVT_FACET_HPP
#define POTHOS_UTF8_CODECVT_FACET_HPP
...
namespace std {
    ...
    #define POTHOS_CODECVT_DO_LENGTH_CONST const
#else
    #define POTHOS_CODECVT_DO_LENGTH_CONST
#endif

// maximum lenght of a multibyte string
#define MB_LENGTH_MAX 8

POTHOS_UTF8_BEGIN_NAMESPACE

struct POTHOS_UTF8_DECL utf8_codecvt_facet :
...
protected:
    ...
    virtual int do_length(
        POTHOS_CODECVT_DO_LENGTH_CONST std::mbstate_t &,
        const char * from,
        const char * from_end, 
        std::size_t max_limit
#if POTHOS_WORKAROUND(__IBMCPP__, POTHOS_TESTED_AT(600))
        ) const throw();
#else
        ) const;
#endif

...
#ifndef POTHOS_MATH_POLICY_HPP
#define POTHOS_MATH_POLICY_HPP

#include <Pothos/serialization/impl/mpl/list.hpp>
#include <Pothos/serialization/impl/mpl/contains.hpp>
...
#include <Pothos/serialization/impl/mpl/vector.hpp>
...
template <class T>
int digits(POTHOS_MATH_EXPLICIT_TEMPLATE_TYPE(T));
template <class T>
T epsilon(POTHOS_MATH_EXPLICIT_TEMPLATE_TYPE(T));
...
//
#ifndef POTHOS_MATH_DOMAIN_ERROR_POLICY
#define POTHOS_MATH_DOMAIN_ERROR_POLICY throw_on_error
#endif
#ifndef POTHOS_MATH_POLE_ERROR_POLICY
#define POTHOS_MATH_POLE_ERROR_POLICY throw_on_error
#endif
#ifndef POTHOS_MATH_OVERFLOW_ERROR_POLICY
#define POTHOS_MATH_OVERFLOW_ERROR_POLICY throw_on_error
#endif
#ifndef POTHOS_MATH_EVALUATION_ERROR_POLICY
#define POTHOS_MATH_EVALUATION_ERROR_POLICY throw_on_error
#endif
#ifndef POTHOS_MATH_ROUNDING_ERROR_POLICY
#define POTHOS_MATH_ROUNDING_ERROR_POLICY throw_on_error
#endif
#ifndef POTHOS_MATH_UNDERFLOW_ERROR_POLICY
#define POTHOS_MATH_UNDERFLOW_ERROR_POLICY ignore_error
#endif
#ifndef POTHOS_MATH_DENORM_ERROR_POLICY
#define POTHOS_MATH_DENORM_ERROR_POLICY ignore_error
#endif
#ifndef POTHOS_MATH_INDETERMINATE_RESULT_ERROR_POLICY
#define POTHOS_MATH_INDETERMINATE_RESULT_ERROR_POLICY ignore_error
#endif
#ifndef POTHOS_MATH_DIGITS10_POLICY
#define POTHOS_MATH_DIGITS10_POLICY 0
#endif
#ifndef POTHOS_MATH_PROMOTE_FLOAT_POLICY
#define POTHOS_MATH_PROMOTE_FLOAT_POLICY true
#endif
#ifndef POTHOS_MATH_PROMOTE_DOUBLE_POLICY
#ifdef POTHOS_MATH_NO_LONG_DOUBLE_MATH_FUNCTIONS
#define POTHOS_MATH_PROMOTE_DOUBLE_POLICY false
#else
#define POTHOS_MATH_PROMOTE_DOUBLE_POLICY true
#endif
#endif
#ifndef POTHOS_MATH_DISCRETE_QUANTILE_POLICY
#define POTHOS_MATH_DISCRETE_QUANTILE_POLICY integer_round_outwards
#endif
#ifndef POTHOS_MATH_ASSERT_UNDEFINED_POLICY
#define POTHOS_MATH_ASSERT_UNDEFINED_POLICY true
#endif
#ifndef POTHOS_MATH_MAX_SERIES_ITERATION_POLICY
#define POTHOS_MATH_MAX_SERIES_ITERATION_POLICY 1000000
#endif
#ifndef POTHOS_MATH_MAX_ROOT_ITERATION_POLICY
#define POTHOS_MATH_MAX_ROOT_ITERATION_POLICY 200
#endif

#if !defined(__BORLANDC__) \
   && !(defined(__GNUC__) && (__GNUC__ == 3) && (__GNUC_MINOR__ <= 2))
#define POTHOS_MATH_META_INT(type, name, Default)\
   template <type N = Default> struct name : public Pothos::mpl::int_<N>{};\
   namespace detail{\
   template <type N>\
   ...
   {\
      ...
      static double test(...);\
      POTHOS_STATIC_CONSTANT(bool, value = sizeof(test(static_cast<T*>(0))) == 1);\
   };\
   }\
   template <class T> struct is_##name : public Pothos::mpl::bool_< ::Pothos::math::policies::detail::is_##name##_imp<T>::value>{};

#define POTHOS_MATH_META_BOOL(name, Default)\
   template <bool N = Default> struct name : public Pothos::mpl::bool_<N>{};\
   namespace detail{\
   template <bool N>\
   char test_is_valid_arg(const name<N>*);\
   char test_is_default_arg(const name<Default>*);\
...
#define POTHOS_MATH_META_INT(Type, name, Default)\
   ...
   {\
      static T inst;\
      POTHOS_STATIC_CONSTANT(bool, value = sizeof( ::Pothos::math::policies::detail::is_##name##_tester<T>::test(inst)) == 1);\
   };\
   }\
   template <class T> struct is_##name : public Pothos::mpl::bool_< ::Pothos::math::policies::detail::is_##name##_imp<T>::value>\
   {\
...
POTHOS_MATH_META_INT(error_policy_type, domain_error, POTHOS_MATH_DOMAIN_ERROR_POLICY)
POTHOS_MATH_META_INT(error_policy_type, pole_error, POTHOS_MATH_POLE_ERROR_POLICY)
POTHOS_MATH_META_INT(error_policy_type, overflow_error, POTHOS_MATH_OVERFLOW_ERROR_POLICY)
POTHOS_MATH_META_INT(error_policy_type, underflow_error, POTHOS_MATH_UNDERFLOW_ERROR_POLICY)
POTHOS_MATH_META_INT(error_policy_type, denorm_error, POTHOS_MATH_DENORM_ERROR_POLICY)
POTHOS_MATH_META_INT(error_policy_type, evaluation_error, POTHOS_MATH_EVALUATION_ERROR_POLICY)
POTHOS_MATH_META_INT(error_policy_type, rounding_error, POTHOS_MATH_ROUNDING_ERROR_POLICY)
POTHOS_MATH_META_INT(error_policy_type, indeterminate_result_error, POTHOS_MATH_INDETERMINATE_RESULT_ERROR_POLICY)

//
// Policy types for internal promotion:
//
POTHOS_MATH_META_BOOL(promote_float, POTHOS_MATH_PROMOTE_FLOAT_POLICY)
POTHOS_MATH_META_BOOL(promote_double, POTHOS_MATH_PROMOTE_DOUBLE_POLICY)
POTHOS_MATH_META_BOOL(assert_undefined, POTHOS_MATH_ASSERT_UNDEFINED_POLICY)
//
...
POTHOS_MATH_META_INT(discrete_quantile_policy_type, discrete_quantile, POTHOS_MATH_DISCRETE_QUANTILE_POLICY)
//
// Precision:
//
POTHOS_MATH_META_INT(int, digits10, POTHOS_MATH_DIGITS10_POLICY)
POTHOS_MATH_META_INT(int, digits2, 0)
//
// Iterations:
//
POTHOS_MATH_META_INT(unsigned long, max_series_iterations, POTHOS_MATH_MAX_SERIES_ITERATION_POLICY)
POTHOS_MATH_META_INT(unsigned long, max_root_iterations, POTHOS_MATH_MAX_ROOT_ITERATION_POLICY)
//
// Define the names for each possible policy:
//
#define POTHOS_MATH_PARAMETER(name)\
   POTHOS_PARAMETER_TEMPLATE_KEYWORD(name##_name)\
   POTHOS_PARAMETER_NAME(name##_name)
...
#ifdef __BORLANDC__
   typedef typename mpl::if_c<
      (Digits2::value > ::Pothos::math::policies::detail::precision<Digits10,Digits2>::digits2_type::value),
...
public:
   typedef typename select_result<
      DefaultType, iter,
      ::Pothos::is_same<iter, end_type>::value>::type type;
};
...
{
   POTHOS_STATIC_CONSTANT(bool, value = sizeof(::Pothos::math::policies::detail::test_is_valid_arg(static_cast<T*>(0))) == 1);
};

template <class T>
struct is_default_policy_imp
{
   POTHOS_STATIC_CONSTANT(bool, value = sizeof(::Pothos::math::policies::detail::test_is_default_arg(static_cast<T*>(0))) == 1);
};

template <class T> struct is_valid_policy 
: public mpl::bool_< 
   ::Pothos::math::policies::detail::is_valid_policy_imp<T>::value>
{};

template <class T> struct is_default_policy 
: public mpl::bool_< 
   ::Pothos::math::policies::detail::is_default_policy_imp<T>::value>
{
   template <class U>
   struct apply
   {
...
typedef default_args<POTHOS_MATH_PROMOTE_FLOAT_POLICY, POTHOS_MATH_PROMOTE_DOUBLE_POLICY>::arg1 forwarding_arg1;
typedef default_args<POTHOS_MATH_PROMOTE_FLOAT_POLICY, POTHOS_MATH_PROMOTE_DOUBLE_POLICY>::arg2 forwarding_arg2;
...
private:
   ...
   //
   POTHOS_STATIC_ASSERT(::Pothos::math::policies::detail::is_valid_policy<A1>::value);
   POTHOS_STATIC_ASSERT(::Pothos::math::policies::detail::is_valid_policy<A2>::value);
   POTHOS_STATIC_ASSERT(::Pothos::math::policies::detail::is_valid_policy<A3>::value);
   POTHOS_STATIC_ASSERT(::Pothos::math::policies::detail::is_valid_policy<A4>::value);
   POTHOS_STATIC_ASSERT(::Pothos::math::policies::detail::is_valid_policy<A5>::value);
   POTHOS_STATIC_ASSERT(::Pothos::math::policies::detail::is_valid_policy<A6>::value);
   POTHOS_STATIC_ASSERT(::Pothos::math::policies::detail::is_valid_policy<A7>::value);
   POTHOS_STATIC_ASSERT(::Pothos::math::policies::detail::is_valid_policy<A8>::value);
   POTHOS_STATIC_ASSERT(::Pothos::math::policies::detail::is_valid_policy<A9>::value);
   POTHOS_STATIC_ASSERT(::Pothos::math::policies::detail::is_valid_policy<A10>::value);
   POTHOS_STATIC_ASSERT(::Pothos::math::policies::detail::is_valid_policy<A11>::value);
   POTHOS_STATIC_ASSERT(::Pothos::math::policies::detail::is_valid_policy<A12>::value);
   POTHOS_STATIC_ASSERT(::Pothos::math::policies::detail::is_valid_policy<A13>::value);
   //
...
#if POTHOS_MATH_DIGITS10_POLICY == 0
...
private:
   ...
   //
   typedef typename detail::append_N<reduced_list, default_policy, (14 - ::Pothos::mpl::size<reduced_list>::value)>::type result_type;
public:
   typedef policy<
...
struct precision
{
   POTHOS_STATIC_ASSERT( ::std::numeric_limits<Real>::radix == 2);
...
struct precision
{
   POTHOS_STATIC_ASSERT((::std::numeric_limits<Real>::radix == 2) || ((::std::numeric_limits<Real>::is_specialized == 0) || (::std::numeric_limits<Real>::digits == 0)));
#ifndef __BORLANDC__
   typedef typename Policy::precision_type precision_type;
   typedef typename mpl::if_c<
...
#ifdef POTHOS_MATH_USE_FLOAT128
...
inline int digits_imp(mpl::true_ const&)
{
   ...
   POTHOS_STATIC_ASSERT( ::std::numeric_limits<T>::is_specialized);
#else
   POTHOS_ASSERT(::std::numeric_limits<T>::is_specialized);
#endif
   typedef typename Pothos::math::policies::precision<T, Policy>::type p_t;
   return p_t::value;
}
...
template <class T, class Policy>
inline int digits(POTHOS_MATH_EXPLICIT_TEMPLATE_TYPE(T))
{
...
struct series_factor_calc<T, Digits, mpl::true_, mpl::true_>
{
   static T get()
   {
      return Pothos::math::tools::epsilon<T>();
   }
};
template <class T, class Digits>
struct series_factor_calc<T, Digits, mpl::true_, mpl::false_>
{
   static T get()
   {
      static const Pothos::uintmax_t v = static_cast<Pothos::uintmax_t>(1u) << (Digits::value - 1);
...
#ifndef POTHOS_NO_LIMITS_COMPILE_TIME_CONSTANTS
   POTHOS_STATIC_ASSERT( ::std::numeric_limits<T>::is_specialized);
   POTHOS_STATIC_ASSERT( ::std::numeric_limits<T>::radix == 2);
#else
   POTHOS_ASSERT(::std::numeric_limits<T>::is_specialized);
   POTHOS_ASSERT(::std::numeric_limits<T>::radix == 2);
#endif
   typedef typename Pothos::math::policies::precision<T, Policy>::type p_t;
   typedef mpl::bool_<p_t::value <= std::numeric_limits<Pothos::uintmax_t>::digits> is_small_int;
...
template <class T, class Policy>
inline T get_epsilon(POTHOS_MATH_EXPLICIT_TEMPLATE_TYPE(T))
{
...
{
   POTHOS_STATIC_CONSTANT(bool, value = (sizeof(::Pothos::math::policies::detail::test_is_policy(static_cast<P*>(0))) == 1));
};

}

template <class P>
struct is_policy : public mpl::bool_< ::Pothos::math::policies::detail::is_policy_imp<P>::value> {};

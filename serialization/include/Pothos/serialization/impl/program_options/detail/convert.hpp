...
#ifndef POTHOS_CONVERT_HPP_VP_2004_04_28
#define POTHOS_CONVERT_HPP_VP_2004_04_28

#include <Pothos/serialization/impl/program_options/config.hpp>

#if !defined(POTHOS_NO_STD_WSTRING)
...
namespace Pothos {
    ...
    namespace program_options
    {
        ...
        */
        POTHOS_PROGRAM_OPTIONS_DECL std::string to_internal(const std::string&);
        /** @overload */
        POTHOS_PROGRAM_OPTIONS_DECL std::string to_internal(const std::wstring&);

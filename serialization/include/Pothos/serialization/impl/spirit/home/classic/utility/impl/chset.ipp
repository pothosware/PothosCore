...
=============================================================================*/
#ifndef POTHOS_SPIRIT_CHSET_IPP
#define POTHOS_SPIRIT_CHSET_IPP

///////////////////////////////////////////////////////////////////////////////
#include <Pothos/serialization/impl/limits.hpp>
#include <Pothos/serialization/impl/spirit/home/classic/utility/chset.hpp>
...
namespace utility { namespace impl {
    ...
    inline void
    detach(Pothos::shared_ptr<basic_chset<CharT> >& ptr)
    {
        if (!ptr.unique())
            ptr = Pothos::shared_ptr<basic_chset<CharT> >
                (new basic_chset<CharT>(*ptr));
    }

    template <typename CharT>
    inline void
    detach_clear(Pothos::shared_ptr<basic_chset<CharT> >& ptr)
    {
        if (ptr.unique())
            ptr->clear();
        else
    ...
    void chset_negated_set(Pothos::shared_ptr<basic_chset<CharT> > &ptr, chlit<CharT> const &ch,
            FakeT)
    {
    ...
    template <typename CharT, typename FakeT>
    void chset_negated_set(Pothos::shared_ptr<basic_chset<CharT> > &ptr,

...
=============================================================================*/
#ifndef POTHOS_SPIRIT_CHSET_HPP
#define POTHOS_SPIRIT_CHSET_HPP
...
#include <Pothos/serialization/impl/spirit/home/classic/utility/impl/chset/basic_chset.hpp>
...
namespace utility { namespace impl {
    ...
    void construct_chset(Pothos::shared_ptr<basic_chset<CharT> >& ptr,
...
private:
    ...
    Pothos::shared_ptr<basic_chset<CharT> > ptr;
};
...
//////////////////////////////////
inline chset< ::Pothos::long_long_type>
chset_p( ::Pothos::long_long_type ch)
{ return chset< ::Pothos::long_long_type>(ch); }

//////////////////////////////////
inline chset< ::Pothos::ulong_long_type>
chset_p( ::Pothos::ulong_long_type ch)
{ return chset< ::Pothos::ulong_long_type>(ch); }
#endif
...
#include <Pothos/serialization/impl/spirit/home/classic/utility/impl/chset.ipp>
#include <Pothos/serialization/impl/spirit/home/classic/utility/chset_operators.hpp>

...
=============================================================================*/
#if !defined(POTHOS_SPIRIT_DIRECTIVES_IPP)
#define POTHOS_SPIRIT_DIRECTIVES_IPP

///////////////////////////////////////////////////////////////////////////////
#include <Pothos/serialization/impl/spirit/home/classic/core/scanner/skipper.hpp>
            ...
            skipper_iteration_policy<BaseT> const&)
        {
            typedef scanner_policies<
                no_skipper_iteration_policy<
                    POTHOS_DEDUCED_TYPENAME ScannerT::iteration_policy_t>,
                POTHOS_DEDUCED_TYPENAME ScannerT::match_policy_t,
                POTHOS_DEDUCED_TYPENAME ScannerT::action_policy_t
            > policies_t;

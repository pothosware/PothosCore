...
=============================================================================*/
#ifndef POTHOS_SPIRIT_NUMERICS_HPP
#define POTHOS_SPIRIT_NUMERICS_HPP
...
#include <Pothos/serialization/impl/spirit/home/classic/core/composite/directives.hpp>

#include <Pothos/serialization/impl/spirit/home/classic/core/primitives/numerics_fwd.hpp>
#include <Pothos/serialization/impl/spirit/home/classic/core/primitives/impl/numerics.ipp>
...
POTHOS_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    struct ureal_parser_policies
    {
        ...
        POTHOS_STATIC_CONSTANT(bool, allow_leading_dot = true);
        POTHOS_STATIC_CONSTANT(bool, allow_trailing_dot = true);
        POTHOS_STATIC_CONSTANT(bool, expect_dot = false);
    ...
    {
        POTHOS_STATIC_CONSTANT(bool, expect_dot = true);
    };

...
#if defined(POTHOS_SPIRIT_USE_OLD_NAMESPACE)
...
#define POTHOS_SPIRIT_CLASSIC_NAMESPACE_BEGIN /*namespace classic {*/
#define POTHOS_SPIRIT_CLASSIC_NS              Pothos::spirit/*::classic*/
#define POTHOS_SPIRIT_CLASSIC_NAMESPACE_END   /*}*/

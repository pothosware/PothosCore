...
=============================================================================*/
#if !defined(POTHOS_SPIRIT_PARSER_HPP)
#define POTHOS_SPIRIT_PARSER_HPP
...
POTHOS_SPIRIT_CLASSIC_NAMESPACE_BEGIN
    ...
    {
        typedef typename Pothos::remove_reference<ParserT>::type parser_type;
...
#include <Pothos/serialization/impl/spirit/home/classic/core/impl/parser.ipp>

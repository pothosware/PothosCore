...
=============================================================================*/
#if !defined(POTHOS_SPIRIT_PRIMITIVES_IPP)
#define POTHOS_SPIRIT_PRIMITIVES_IPP

// This should eventually go to a config file.
#if defined(__GNUC__) && (__GNUC__ < 3) && !defined(_STLPORT_VERSION)
#  ifndef POTHOS_SPIRIT_NO_CHAR_TRAITS
#    define POTHOS_SPIRIT_NO_CHAR_TRAITS
#  endif
#endif

#include <cctype>
#if !defined(POTHOS_NO_CWCTYPE)
#include <cwctype>
#endif
...
#ifndef POTHOS_SPIRIT_NO_CHAR_TRAITS
#  define POTHOS_SPIRIT_CHAR_TRAITS_NAMESPACE std
#else
...
#  define POTHOS_SPIRIT_CHAR_TRAITS_NAMESPACE impl
...
#  endif
        ...
        {
            typedef CharT char_type;
            typedef typename POTHOS_SPIRIT_CHAR_TRAITS_NAMESPACE
                ::char_traits<CharT>::int_type int_type;

            static int_type to_int_type(CharT c)
            {
                return POTHOS_SPIRIT_CHAR_TRAITS_NAMESPACE

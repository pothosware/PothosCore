...
=============================================================================*/
#ifndef POTHOS_SPIRIT_CHSET_OPERATORS_IPP
#define POTHOS_SPIRIT_CHSET_OPERATORS_IPP
...
namespace impl {
    ...
    template <typename CharT>
    inline POTHOS_SPIRIT_CLASSIC_NS::range<CharT> const&
    full()
    {
        static POTHOS_SPIRIT_CLASSIC_NS::range<CharT> full_(
    ...
    empty()
    {
        static POTHOS_SPIRIT_CLASSIC_NS::range<CharT> empty_;
        return empty_;
    }
}

...
=============================================================================*/
#if !defined(POTHOS_SPIRIT_DEBUG_NODE_HPP)
#define POTHOS_SPIRIT_DEBUG_NODE_HPP

#if !defined(POTHOS_SPIRIT_DEBUG_MAIN_HPP)
#error "You must include Pothos/serialization/impl/spirit/debug.hpp, not Pothos/serialization/impl/spirit/debug/debug_node.hpp"
#endif
...
#include <Pothos/serialization/impl/spirit/home/classic/core/primitives/primitives.hpp> // for iscntrl_
...
namespace impl {
    ...
    {
    #if !defined(POTHOS_SPIRIT_DEBUG_TOKEN_PRINTER)

        token_printer_aux<CharT>::print(o, c);

    #else

        POTHOS_SPIRIT_DEBUG_TOKEN_PRINTER(o, c);
...
///////////////////////////////////////////////////////////////////////////////
...
#if POTHOS_SPIRIT_DEBUG_FLAGS & POTHOS_SPIRIT_DEBUG_FLAGS_NODES
        ...
        IteratorT first, IteratorT last)
    {
        if (!name.empty())
        {
            ...
            POTHOS_SPIRIT_DEBUG_OUT << name << ":\t\"";
            IteratorT iter = first;
            IteratorT ilast = last;
            for (int j = 0; j < POTHOS_SPIRIT_DEBUG_PRINT_SOME; ++j)
            {
                if (iter == ilast)
                    break;

                token_printer(POTHOS_SPIRIT_DEBUG_OUT, *iter);
                ++iter;
            }
            POTHOS_SPIRIT_DEBUG_OUT << "\"\n";
        }
...
#if POTHOS_SPIRIT_DEBUG_FLAGS & POTHOS_SPIRIT_DEBUG_FLAGS_CLOSURES
    ...
    print_closure_info(ResultT &hit, int level, std::string const& name)
    {
        ...
        // for now, print out the return value only
            ...
            if (hit.has_valid_attribute())
                POTHOS_SPIRIT_DEBUG_OUT << hit.value();
            else
                POTHOS_SPIRIT_DEBUG_OUT << "undefined attribute";
            POTHOS_SPIRIT_DEBUG_OUT << "\n";
        }
        return hit;
    }
...
//
///////////////////////////////////////////////////////////////////////////////
#if !defined(POTHOS_SPIRIT_PARSER_CONTEXT_LINKER_DEFINED)
#define POTHOS_SPIRIT_PARSER_CONTEXT_LINKER_DEFINED
...
#if !defined(POTHOS_SPIRIT_PARSER_SCANNER_LINKER_DEFINED)
#define POTHOS_SPIRIT_PARSER_SCANNER_LINKER_DEFINED
...
#if !defined(POTHOS_SPIRIT_CLOSURE_CONTEXT_LINKER_DEFINED)
#define POTHOS_SPIRIT_CLOSURE_CONTEXT_LINKER_DEFINED

...
#ifndef POTHOS_TRANSFORM_ITERATOR_23022003THW_HPP
#define POTHOS_TRANSFORM_ITERATOR_23022003THW_HPP
...
#include <Pothos/serialization/impl/type_traits/function_traits.hpp>
...
#include <Pothos/serialization/impl/utility/result_of.hpp>
...
namespace Pothos
{
  ...
  template <class UnaryFunc, class Iterator, class Reference, class Value>
  class transform_iterator
    : public Pothos::detail::transform_iterator_base<UnaryFunc, Iterator, Reference, Value>::type
  {
    typedef typename
    Pothos::detail::transform_iterator_base<UnaryFunc, Iterator, Reference, Value>::type
    super_t;

...
#ifndef POTHOS_ITERATOR_CATEGORIES_HPP
# define POTHOS_ITERATOR_CATEGORIES_HPP
...
struct iterator_category_to_traversal
  : mpl::eval_if< // if already convertible to a traversal tag, we're done.
      ...
      , mpl::identity<Cat>
      , Pothos::detail::old_category_to_traversal<Cat>
    >
{};
...
struct iterator_traversal
  : iterator_category_to_traversal<
        typename Pothos::detail::iterator_traits<Iterator>::iterator_category
    >
{};

# ifdef POTHOS_MPL_CFG_NO_FULL_LAMBDA_SUPPORT

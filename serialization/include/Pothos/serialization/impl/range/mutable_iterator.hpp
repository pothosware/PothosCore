...
#ifndef POTHOS_RANGE_MUTABLE_ITERATOR_HPP
#define POTHOS_RANGE_MUTABLE_ITERATOR_HPP
...
#include <Pothos/serialization/impl/range/detail/iterator.hpp>
#else
...
namespace Pothos
{
    ...
    namespace range_detail {
        POTHOS_RANGE_EXTRACT_OPTIONAL_TYPE( iterator )
    }

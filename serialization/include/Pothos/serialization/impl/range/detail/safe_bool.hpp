...
#ifndef POTHOS_RANGE_SAFE_BOOL_INCLUDED_HPP
#define POTHOS_RANGE_SAFE_BOOL_INCLUDED_HPP
...
#if (defined(__SUNPRO_CC) && POTHOS_WORKAROUND(__SUNPRO_CC, < 0x570)) || defined(__CINT_)

...
namespace POTHOS_JOIN(POTHOS_TT_TRAIT_NAME,_impl) {
...
no_operator operator POTHOS_TT_TRAIT_OP (const any&, const any&);
...
struct operator_returns_void {
   ...
   static ::Pothos::type_traits::yes_type returns_void(returns_void_t);
   static ::Pothos::type_traits::no_type returns_void(int);
   POTHOS_STATIC_CONSTANT(bool, value = (sizeof(::Pothos::type_traits::yes_type)==sizeof(returns_void((make<Lhs>() POTHOS_TT_TRAIT_OP make<Rhs>(),returns_void_t())))));
};
...
struct operator_returns_Ret < Lhs, Rhs, Ret, false > {
   static ::Pothos::type_traits::yes_type is_convertible_to_Ret(Ret); // this version is preferred for types convertible to Ret
   static ::Pothos::type_traits::no_type is_convertible_to_Ret(...); // this version is used otherwise

   POTHOS_STATIC_CONSTANT(bool, value = (sizeof(is_convertible_to_Ret(make<Lhs>() POTHOS_TT_TRAIT_OP make<Rhs>()))==sizeof(::Pothos::type_traits::yes_type)));
};
...
struct operator_exists {
   static ::Pothos::type_traits::yes_type check(has_operator); // this version is preferred when operator exists
   static ::Pothos::type_traits::no_type check(no_operator); // this version is used otherwise

   POTHOS_STATIC_CONSTANT(bool, value = (sizeof(check(((make<Lhs>() POTHOS_TT_TRAIT_OP make<Rhs>()),make<has_operator>())))==sizeof(::Pothos::type_traits::yes_type)));
};
...
template < typename Lhs, typename Rhs, typename Ret >
struct trait_impl {
   typedef typename ::Pothos::remove_reference<Lhs>::type Lhs_noref;
   typedef typename ::Pothos::remove_reference<Rhs>::type Rhs_noref;
   typedef typename ::Pothos::remove_cv<Lhs_noref>::type Lhs_nocv;
   typedef typename ::Pothos::remove_cv<Rhs_noref>::type Rhs_nocv;
   typedef typename ::Pothos::remove_cv< typename ::Pothos::remove_reference< typename ::Pothos::remove_pointer<Lhs_noref>::type >::type >::type Lhs_noptr;
   typedef typename ::Pothos::remove_cv< typename ::Pothos::remove_reference< typename ::Pothos::remove_pointer<Rhs_noref>::type >::type >::type Rhs_noptr;
   POTHOS_STATIC_CONSTANT(bool, value = (trait_impl1 < Lhs_noref, Rhs_noref, Ret, POTHOS_TT_FORBIDDEN_IF >::value));
};
...
POTHOS_TT_AUX_BOOL_TRAIT_DEF3(POTHOS_TT_TRAIT_NAME, Lhs, Rhs=Lhs, Ret=::Pothos::detail::POTHOS_JOIN(POTHOS_TT_TRAIT_NAME,_impl)::dont_care, (::Pothos::detail::POTHOS_JOIN(POTHOS_TT_TRAIT_NAME,_impl)::trait_impl < Lhs, Rhs, Ret >::value))

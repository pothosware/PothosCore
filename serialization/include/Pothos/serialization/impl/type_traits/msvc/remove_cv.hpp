...
#ifndef POTHOS_TYPE_TRAITS_MSVC_REMOVE_CV_HOLT_2004_0901
#define POTHOS_TYPE_TRAITS_MSVC_REMOVE_CV_HOLT_2004_0901
...
namespace Pothos {
    ...
    template<typename T>
    struct remove_cv {
        typedef Pothos::detail::remove_cv_impl_typeof<
        ...
        typedef typename 
            ...
            >::type
        type;
        POTHOS_MPL_AUX_LAMBDA_SUPPORT(1,remove_cv,T)
    };
}//namespace boost

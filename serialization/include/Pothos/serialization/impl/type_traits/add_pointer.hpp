...
#ifndef POTHOS_TT_ADD_POINTER_HPP_INCLUDED
#define POTHOS_TT_ADD_POINTER_HPP_INCLUDED
...
POTHOS_TT_AUX_TYPE_TRAIT_DEF1(add_pointer,T,typename Pothos::detail::add_pointer_impl<T>::type)

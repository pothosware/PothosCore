...
#ifndef POTHOS_TT_REMOVE_CONST_HPP_INCLUDED
#define POTHOS_TT_REMOVE_CONST_HPP_INCLUDED
...
#include <Pothos/serialization/impl/type_traits/msvc/remove_const.hpp>
#endif
...
POTHOS_TT_AUX_TYPE_TRAIT_DEF1(remove_const,T,typename Pothos::detail::remove_const_impl<T>::type)
POTHOS_TT_AUX_TYPE_TRAIT_PARTIAL_SPEC1_1(typename T,remove_const,T&,T&)
#if !defined(POTHOS_NO_ARRAY_TYPE_SPECIALIZATIONS)
POTHOS_TT_AUX_TYPE_TRAIT_PARTIAL_SPEC1_2(typename T,std::size_t N,remove_const,T const[N],T type[N])
POTHOS_TT_AUX_TYPE_TRAIT_PARTIAL_SPEC1_2(typename T,std::size_t N,remove_const,T const volatile[N],T volatile type[N])
#endif

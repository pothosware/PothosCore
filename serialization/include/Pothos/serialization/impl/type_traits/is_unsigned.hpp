...
#ifndef POTHOS_TT_IS_UNSIGNED_HPP_INCLUDED
#define POTHOS_TT_IS_UNSIGNED_HPP_INCLUDED
...
#if !(defined(__EDG_VERSION__) && __EDG_VERSION__ <= 238) && !defined(POTHOS_NO_INCLASS_MEMBER_INITIALIZATION)
...
{
   POTHOS_STATIC_CONSTANT(bool, value = (::Pothos::detail::is_unsigned_values<T>::minus_one > ::Pothos::detail::is_unsigned_values<T>::zero));
};
...
#endif
#if defined(WCHAR_MIN) && (WCHAR_MIN == 0) && !defined(POTHOS_NO_INTRINSIC_WCHAR_T)
...
#if defined( __CODEGEARC__ )
POTHOS_TT_AUX_BOOL_TRAIT_DEF1(is_unsigned,T,__is_unsigned(T))
#else
POTHOS_TT_AUX_BOOL_TRAIT_DEF1(is_unsigned,T,::Pothos::detail::is_unsigned_imp<T>::value)
#endif

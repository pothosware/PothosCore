...
#ifndef POTHOS_TT_HAS_NEW_OPERATOR_HPP_INCLUDED
#define POTHOS_TT_HAS_NEW_OPERATOR_HPP_INCLUDED
...
namespace detail {
    ...
    struct has_new_operator_impl {
        ...
        // of s1 in the computation of value.
        #ifdef __GNUC__
            POTHOS_STATIC_CONSTANT(unsigned, s1 = sizeof(has_new_operator_impl<T>::template check_sig1<T>(0)));
            POTHOS_STATIC_CONSTANT(unsigned, s2 = sizeof(has_new_operator_impl<T>::template check_sig2<T>(0)));
            POTHOS_STATIC_CONSTANT(unsigned, s3 = sizeof(has_new_operator_impl<T>::template check_sig3<T>(0)));
            POTHOS_STATIC_CONSTANT(unsigned, s4 = sizeof(has_new_operator_impl<T>::template check_sig4<T>(0)));
            POTHOS_STATIC_CONSTANT(unsigned, s5 = sizeof(has_new_operator_impl<T>::template check_sig5<T>(0)));
            POTHOS_STATIC_CONSTANT(unsigned, s6 = sizeof(has_new_operator_impl<T>::template check_sig6<T>(0)));
        #else
            ...
            POTHOS_STATIC_CONSTANT(unsigned, s1 = sizeof(check_sig1<T>(0)));
            POTHOS_STATIC_CONSTANT(unsigned, s2 = sizeof(check_sig2<T>(0)));
            POTHOS_STATIC_CONSTANT(unsigned, s3 = sizeof(check_sig3<T>(0)));
            POTHOS_STATIC_CONSTANT(unsigned, s4 = sizeof(check_sig4<T>(0)));
            POTHOS_STATIC_CONSTANT(unsigned, s5 = sizeof(check_sig5<T>(0)));
            POTHOS_STATIC_CONSTANT(unsigned, s6 = sizeof(check_sig6<T>(0)));
...
POTHOS_TT_AUX_BOOL_TRAIT_DEF1(has_new_operator,T,::Pothos::detail::has_new_operator_impl<T>::value)

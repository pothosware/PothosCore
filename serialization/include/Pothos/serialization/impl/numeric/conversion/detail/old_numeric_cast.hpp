...
#ifndef POTHOS_OLD_NUMERIC_CAST_HPP
#define POTHOS_OLD_NUMERIC_CAST_HPP
...
#  define POTHOS_EXPLICIT_DEFAULT_TARGET , ::Pothos::type<Target>* = 0
# else
#  define POTHOS_EXPLICIT_DEFAULT_TARGET
# endif
...
//  numeric_cast  ------------------------------------------------------------//
...
#if !defined(POTHOS_NO_LIMITS_COMPILE_TIME_CONSTANTS) || defined(POTHOS_SGI_CPP_LIMITS)
    ...
    namespace detail
    {
      ...
      {
             static inline T min POTHOS_PREVENT_MACRO_SUBSTITUTION ()
         {
      ...
      struct fixed_numeric_limits_base
          : public if_true< std::numeric_limits<T>::is_signed >
           ::POTHOS_NESTED_TEMPLATE then< signed_numeric_limits<T>,
...
# ifdef POTHOS_HAS_LONG_LONG
      ...
      template <>
      struct fixed_numeric_limits_base< ::Pothos::long_long_type, false>
      {
          POTHOS_STATIC_CONSTANT(bool, is_specialized = true);
          POTHOS_STATIC_CONSTANT(bool, is_signed = true);
          static  ::Pothos::long_long_type max POTHOS_PREVENT_MACRO_SUBSTITUTION ()
          {
#  ifdef LONGLONG_MAX
              return LONGLONG_MAX;
#  else
...
#  endif
          ...
          static  ::Pothos::long_long_type min POTHOS_PREVENT_MACRO_SUBSTITUTION ()
          {
#  ifdef LONGLONG_MIN
              return LONGLONG_MIN;
#  else
...
#  endif
      ...
      template <>
      struct fixed_numeric_limits_base< ::Pothos::ulong_long_type, false>
      {
          POTHOS_STATIC_CONSTANT(bool, is_specialized = true);
          POTHOS_STATIC_CONSTANT(bool, is_signed = false);
          static  ::Pothos::ulong_long_type max POTHOS_PREVENT_MACRO_SUBSTITUTION ()
          {
#  ifdef ULONGLONG_MAX
...
#  endif
          ...
          static  ::Pothos::ulong_long_type min POTHOS_PREVENT_MACRO_SUBSTITUTION () { return 0; }
      };
# endif
    } // namespace detail
...
#  define POTHOS_UINT64_CAST(src_type)                                   \
        ...
        POTHOS_UINT64_CAST(long double);
        POTHOS_UINT64_CAST(double);
        POTHOS_UINT64_CAST(float);
#  undef POTHOS_UINT64_CAST
# endif
    };
...
# endif
    ...
    inline Target numeric_cast(Source arg POTHOS_EXPLICIT_DEFAULT_TARGET)
    {
        // typedefs abbreviating respective trait classes
        typedef detail::fixed_numeric_limits<Source> arg_traits;
        typedef detail::fixed_numeric_limits<Target> result_traits;

#if defined(POTHOS_STRICT_CONFIG) \
    || (!defined(__HP_aCC) || __HP_aCC > 33900) \
         && (!defined(POTHOS_NO_LIMITS_COMPILE_TIME_CONSTANTS) \
             || defined(POTHOS_SGI_CPP_LIMITS))
...
#  undef POTHOS_EXPLICIT_DEFAULT_TARGET

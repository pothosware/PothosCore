...
#ifndef POTHOS_MPL_LONG_FWD_HPP_INCLUDED
#define POTHOS_MPL_LONG_FWD_HPP_INCLUDED
...
template< POTHOS_MPL_AUX_NTTP_DECL(long, N) > struct long_;

POTHOS_MPL_AUX_ADL_BARRIER_NAMESPACE_CLOSE
POTHOS_MPL_AUX_ADL_BARRIER_DECL(long_)

...
#ifndef POTHOS_MPL_INTEGRAL_C_HPP_INCLUDED
#define POTHOS_MPL_INTEGRAL_C_HPP_INCLUDED
...
#include <Pothos/serialization/impl/mpl/integral_c_fwd.hpp>
...
#include <Pothos/serialization/impl/mpl/aux_/integral_wrapper.hpp>


#if !defined(POTHOS_NO_TEMPLATE_PARTIAL_SPECIALIZATION) \
 && !POTHOS_WORKAROUND(__BORLANDC__, <= 0x551)

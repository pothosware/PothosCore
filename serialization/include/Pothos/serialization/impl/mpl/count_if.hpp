...
#ifndef POTHOS_MPL_COUNT_IF_HPP_INCLUDED
#define POTHOS_MPL_COUNT_IF_HPP_INCLUDED
...
struct count_if
    : aux::msvc_eti_base< typename fold<
        ...
        >::type >
{
    POTHOS_MPL_AUX_LAMBDA_SUPPORT(2,count_if,(Sequence,Predicate))
};

POTHOS_MPL_AUX_NA_SPEC(2, count_if)

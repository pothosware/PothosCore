...
#ifndef POTHOS_MPL_PARTITION_HPP_INCLUDED
#define POTHOS_MPL_PARTITION_HPP_INCLUDED
...
#include <Pothos/serialization/impl/mpl/stable_partition.hpp>
...
POTHOS_MPL_AUX_INSERTER_ALGORITHM_DEF(4, partition)

...
#ifndef POTHOS_MPL_AUX_TRANSFORM_ITER_HPP_INCLUDED
#define POTHOS_MPL_AUX_TRANSFORM_ITER_HPP_INCLUDED
...
struct transform_iter
    : transform_iter_impl<
          ::Pothos::is_same<Iterator,LastIterator>::value
...
POTHOS_MPL_AUX_PASS_THROUGH_LAMBDA_SPEC(3, aux::transform_iter)

...
#ifndef POTHOS_MPL_AUX_COUNT_IMPL_HPP_INCLUDED
#define POTHOS_MPL_AUX_COUNT_IMPL_HPP_INCLUDED
...
#include <Pothos/serialization/impl/mpl/count_if.hpp>
...
template< typename Tag > struct count_impl
{
...
#if POTHOS_WORKAROUND(__BORLANDC__,POTHOS_TESTED_AT(0x561))
    {
        ...
        POTHOS_STATIC_CONSTANT(int, value = POTHOS_MPL_AUX_VALUE_WKND(type)::value);
#else
...
POTHOS_MPL_ALGORITM_TRAITS_LAMBDA_SPEC(2,count_impl)

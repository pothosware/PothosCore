...
#ifndef POTHOS_MPL_AUX_LAMBDA_ARITY_PARAM_HPP_INCLUDED
#define POTHOS_MPL_AUX_LAMBDA_ARITY_PARAM_HPP_INCLUDED
...
#   define POTHOS_MPL_AUX_LAMBDA_ARITY_PARAM(param)    
#else
#   define POTHOS_MPL_AUX_LAMBDA_ARITY_PARAM(param) , param
#endif

...
#   define AUX778076_ITER_FOLD_FORWARD_STEP(unused, n_, unused2) \
    typedef typename apply2< \
          ForwardOp \
        , POTHOS_PP_CAT(fwd_state,n_) \
        , AUX778076_FOLD_IMPL_OP(POTHOS_PP_CAT(iter,n_)) \
        >::type POTHOS_PP_CAT(fwd_state,POTHOS_PP_INC(n_)); \
    typedef typename mpl::next<POTHOS_PP_CAT(iter,n_)>::type \
        POTHOS_PP_CAT(iter,POTHOS_PP_INC(n_)); \
    /**/

#   define AUX778076_ITER_FOLD_BACKWARD_STEP_FUNC(n_) \
    typedef typename apply2< \
          BackwardOp \
        , POTHOS_PP_CAT(bkwd_state,n_) \
        , AUX778076_FOLD_IMPL_OP(POTHOS_PP_CAT(iter,POTHOS_PP_DEC(n_))) \
        >::type POTHOS_PP_CAT(bkwd_state,POTHOS_PP_DEC(n_)); \
    /**/

#   define AUX778076_ITER_FOLD_BACKWARD_STEP(unused, n_, j) \
    AUX778076_ITER_FOLD_BACKWARD_STEP_FUNC( \
          POTHOS_PP_SUB_D(1,j,n_) \
        ) \
    /**/

#   define AUX778076_FIRST_BACKWARD_STATE_TYPEDEF(n_) \
    typedef typename nested_chunk::state POTHOS_PP_CAT(bkwd_state,n_);
    /**/
...
#   define POTHOS_PP_ITERATION_PARAMS_1 \
    (3,(0, POTHOS_MPL_LIMIT_UNROLLING, <boost/mpl/aux_/reverse_fold_impl_body.hpp>))
...
struct AUX778076_FOLD_IMPL_NAME
{
    ...
    typedef AUX778076_FOLD_IMPL_NAME<
        ...
        , POTHOS_PP_CAT(iter,POTHOS_MPL_LIMIT_UNROLLING)
        , Last
        , POTHOS_PP_CAT(fwd_state,POTHOS_MPL_LIMIT_UNROLLING)
        , BackwardOp
        , ForwardOp
        > nested_chunk;
        
    AUX778076_FIRST_BACKWARD_STATE_TYPEDEF(POTHOS_MPL_LIMIT_UNROLLING)
...
struct AUX778076_FOLD_CHUNK_NAME<-1>
{
    ...
    struct result_
    {
        typedef typename if_<
            ...
            , POTHOS_PP_CAT(AUX778076_FOLD_IMPL_NAME_PREFIX,_step)<First,Last,State,BackwardOp,ForwardOp>
            >::type res_;
...
struct AUX778076_FOLD_IMPL_NAME<n_,First,Last,State,BackwardOp,ForwardOp>
{
    ...
    typedef POTHOS_PP_CAT(fwd_state,n_) POTHOS_PP_CAT(bkwd_state,n_);

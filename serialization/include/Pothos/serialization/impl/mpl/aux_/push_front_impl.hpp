...
#ifndef POTHOS_MPL_AUX_PUSH_FRONT_IMPL_HPP_INCLUDED
#define POTHOS_MPL_AUX_PUSH_FRONT_IMPL_HPP_INCLUDED
...
struct push_front_impl
{
    template< typename Sequence, typename T > struct apply
    {
        ...
        POTHOS_MPL_ASSERT_MSG(
              ( Pothos::is_same< T, has_push_front_arg >::value )
...
POTHOS_MPL_ALGORITM_TRAITS_LAMBDA_SPEC(2, push_front_impl)
POTHOS_MPL_ALGORITM_TRAITS_LAMBDA_SPEC(1, has_push_front_impl)

...
#ifndef POTHOS_MPL_AUX_CONFIG_ETI_HPP_INCLUDED
#define POTHOS_MPL_AUX_CONFIG_ETI_HPP_INCLUDED
...
#   define POTHOS_MPL_CFG_MSVC_60_ETI_BUG
...
#   define POTHOS_MPL_CFG_MSVC_70_ETI_BUG
    ...
    && ( defined(POTHOS_MPL_CFG_MSVC_60_ETI_BUG) \
        || defined(POTHOS_MPL_CFG_MSVC_70_ETI_BUG) \
        )

#   define POTHOS_MPL_CFG_MSVC_ETI_BUG

...
#ifndef POTHOS_MPL_O1_SIZE_IMPL_HPP_INCLUDED
#define POTHOS_MPL_O1_SIZE_IMPL_HPP_INCLUDED
...
#include <Pothos/serialization/impl/mpl/aux_/has_size.hpp>
...
#   if !POTHOS_WORKAROUND(POTHOS_MSVC, < 1300) \
    && !POTHOS_WORKAROUND(__MWERKS__, POTHOS_TESTED_AT(0x3003))

...
#ifndef POTHOS_MPL_AUX_REVERSE_FOLD_IMPL_HPP_INCLUDED
#define POTHOS_MPL_AUX_REVERSE_FOLD_IMPL_HPP_INCLUDED
...
#   define POTHOS_MPL_PREPROCESSED_HEADER reverse_fold_impl.hpp

...
#   include <Pothos/serialization/impl/preprocessor/enum_params_with_a_default.hpp>
#   include <Pothos/serialization/impl/preprocessor/enum_params.hpp>
#   include <Pothos/serialization/impl/preprocessor/enum.hpp>
...
#   define AUX778076_SEQUENCE_NAME_N(n) \
    POTHOS_PP_CAT(AUX778076_SEQUENCE_BASE_NAME,n) \
    /**/
...
#   define AUX778076_SEQUENCE_N_PARAMS(n) \
    POTHOS_PP_ENUM_PARAMS(n, AUX778076_SEQUENCE_TEMPLATE_PARAM) \
    /**/

#   define AUX778076_SEQUENCE_N_ARGS(n) \
    POTHOS_PP_ENUM_PARAMS(n, T) \
    /**/
...
#   define AUX778076_SEQUENCE_N_PARTIAL_SPEC_ARGS(n) \
    ...
    POTHOS_PP_ENUM( \
          POTHOS_PP_SUB_D(1,AUX778076_SEQUENCE_LIMIT,n) \
        , POTHOS_PP_TUPLE_ELEM_3_2 \
        , AUX778076_SEQUENCE_DEFAULT \
        ) \
    /**/
...
#   define AUX778076_SEQUENCE_TEMPLATE_PARAM POTHOS_MPL_AUX_NTTP_DECL(long, C)
#   define AUX778076_SEQUENCE_DEFAULT LONG_MAX

#   define AUX778076_SEQUENCE_PARAMS() \
    typename T, POTHOS_PP_ENUM_PARAMS( \
          AUX778076_SEQUENCE_LIMIT \
        , AUX778076_SEQUENCE_TEMPLATE_PARAM \
        ) \
    /**/
...
#   define AUX778076_SEQUENCE_N_PARAMS(n) \
    typename T POTHOS_PP_COMMA_IF(n) \
    POTHOS_PP_ENUM_PARAMS(n, AUX778076_SEQUENCE_TEMPLATE_PARAM) \
    /**/

#   if !defined(AUX778076_SEQUENCE_CONVERT_CN_TO)
#       define AUX778076_SEQUENCE_CONVERT_CN_TO(z,n,TARGET) POTHOS_PP_CAT(C,n)
#   endif

#   define AUX778076_SEQUENCE_N_ARGS(n) \
    T POTHOS_PP_COMMA_IF(n) \
    POTHOS_PP_ENUM(n,AUX778076_SEQUENCE_CONVERT_CN_TO,T) \
    /**/

#   define AUX778076_SEQUENCE_N_PARTIAL_SPEC_ARGS(n) \
    T, POTHOS_PP_ENUM_PARAMS(n, C) \
    POTHOS_PP_COMMA_IF(n) \
    POTHOS_PP_ENUM( \
          POTHOS_PP_SUB_D(1,AUX778076_SEQUENCE_LIMIT,n) \
        , POTHOS_PP_TUPLE_ELEM_3_2 \
...
struct POTHOS_PP_CAT(AUX778076_SEQUENCE_NAME,_chooser);
}
#endif
...
template<
    ...
    >
struct POTHOS_PP_CAT(AUX778076_SEQUENCE_NAME,_impl)
{
    typedef aux::POTHOS_PP_CAT(AUX778076_SEQUENCE_NAME,_count_args)<
          POTHOS_PP_ENUM_PARAMS(AUX778076_SEQUENCE_LIMIT, AUX778076_SEQUENCE_PARAM_NAME)
        > arg_num_;
    
    typedef typename aux::POTHOS_PP_CAT(AUX778076_SEQUENCE_NAME,_chooser)< arg_num_::value >
...
template<
    ...
    >
struct AUX778076_SEQUENCE_NAME
    : aux::POTHOS_PP_CAT(AUX778076_SEQUENCE_NAME,_impl)<
          AUX778076_SEQUENCE_ARGS()
        >::type
{
    typedef typename aux::POTHOS_PP_CAT(AUX778076_SEQUENCE_NAME,_impl)<
          AUX778076_SEQUENCE_ARGS()
        >::type type;
};
...
template<>
struct POTHOS_PP_CAT(AUX778076_SEQUENCE_NAME,_chooser)<i_>
{
    template<
          AUX778076_SEQUENCE_PARAMS()
        >

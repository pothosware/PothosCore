...
#ifndef POTHOS_MPL_AUX_NUMERIC_CAST_HPP_INCLUDED
#define POTHOS_MPL_AUX_NUMERIC_CAST_HPP_INCLUDED
...
struct cast1st_impl
{
    template< typename N1, typename N2 > struct apply
        ...
        : apply_wrap2< 
              F
            , typename apply_wrap1< POTHOS_MPL_AUX_NUMERIC_CAST<Tag1,Tag2>,N1 >::type
            , N2
            >
    {
#else
...
struct cast2nd_impl
{
    template< typename N1, typename N2 > struct apply
        ...
        : apply_wrap2< 
              F
            , N1
            , typename apply_wrap1< POTHOS_MPL_AUX_NUMERIC_CAST<Tag2,Tag1>,N2 >::type
            >
    {
#else
    {

...
#ifndef POTHOS_MPL_AUX_POP_BACK_IMPL_HPP_INCLUDED
#define POTHOS_MPL_AUX_POP_BACK_IMPL_HPP_INCLUDED
...
POTHOS_MPL_ALGORITM_TRAITS_LAMBDA_SPEC(1, pop_back_impl)

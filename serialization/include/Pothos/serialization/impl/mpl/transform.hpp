...
#ifndef POTHOS_MPL_TRANSFORM_HPP_INCLUDED
#define POTHOS_MPL_TRANSFORM_HPP_INCLUDED
...
#include <Pothos/serialization/impl/mpl/pair_view.hpp>
...
POTHOS_MPL_AUX_INSERTER_ALGORITHM_DEF(3, transform1)                    
POTHOS_MPL_AUX_INSERTER_ALGORITHM_DEF(4, transform2)
    
#define AUX778076_TRANSFORM_DEF(name)                                   \
template<                                                               \
      typename POTHOS_MPL_AUX_NA_PARAM(Seq1)                             \
    , typename POTHOS_MPL_AUX_NA_PARAM(Seq2OrOperation)                  \
    , typename POTHOS_MPL_AUX_NA_PARAM(OperationOrInserter)              \
    , typename POTHOS_MPL_AUX_NA_PARAM(Inserter)                         \
    >                                                                   \
struct name                                                             \
{                                                                       \

...
#ifndef POTHOS_MPL_INDEX_IF_HPP_INCLUDED
#define POTHOS_MPL_INDEX_IF_HPP_INCLUDED
...
struct index_if
{
    ...
    POTHOS_MPL_AUX_LAMBDA_SUPPORT(2,index_if,(Sequence,Predicate))
};

POTHOS_MPL_AUX_NA_SPEC(2, index_if)

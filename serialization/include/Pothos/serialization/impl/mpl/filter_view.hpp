...
#ifndef POTHOS_MPL_FILTER_VIEW_HPP_INCLUDED
#define POTHOS_MPL_FILTER_VIEW_HPP_INCLUDED
...
#include <Pothos/serialization/impl/mpl/aux_/filter_iter.hpp>
...
POTHOS_MPL_AUX_NA_SPEC(2, filter_view)

...
#   define AUX778076_HEADER \
    plain/POTHOS_MPL_PREPROCESSED_HEADER \
/**/
#else
#   define AUX778076_HEADER \
    POTHOS_PP_CAT(plain,/)##POTHOS_MPL_PREPROCESSED_HEADER \
/**/
#endif

#if POTHOS_WORKAROUND(__IBMCPP__, POTHOS_TESTED_AT(700))
#   define AUX778076_INCLUDE_STRING POTHOS_PP_STRINGIZE(Pothos/serialization/impl/mpl/set/aux_/preprocessed/AUX778076_HEADER)
#   include AUX778076_INCLUDE_STRING
#   undef AUX778076_INCLUDE_STRING
#else
#   include POTHOS_PP_STRINGIZE(Pothos/serialization/impl/mpl/set/aux_/preprocessed/AUX778076_HEADER)
#endif

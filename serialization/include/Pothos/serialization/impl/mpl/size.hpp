...
#ifndef POTHOS_MPL_SIZE_HPP_INCLUDED
#define POTHOS_MPL_SIZE_HPP_INCLUDED
...
#include <Pothos/serialization/impl/mpl/aux_/size_impl.hpp>
...
struct size
    : aux::msvc_eti_base<
      ...
      >::type
{
    POTHOS_MPL_AUX_LAMBDA_SUPPORT(1, size, (Sequence))
};

POTHOS_MPL_AUX_NA_SPEC(1, size)

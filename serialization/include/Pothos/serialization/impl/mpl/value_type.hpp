...
#ifndef POTHOS_MPL_VALUE_TYPE_HPP_INCLUDED
#define POTHOS_MPL_VALUE_TYPE_HPP_INCLUDED
...
#include <Pothos/serialization/impl/mpl/value_type_fwd.hpp>
...
{
    POTHOS_MPL_AUX_LAMBDA_SUPPORT(2,value_type,(AssociativeSequence,T))
};

POTHOS_MPL_AUX_NA_SPEC(2, value_type)

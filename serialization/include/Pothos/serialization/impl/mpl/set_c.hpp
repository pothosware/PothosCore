...
#ifndef POTHOS_MPL_SET_C_HPP_INCLUDED
#define POTHOS_MPL_SET_C_HPP_INCLUDED
...
#   define AUX778076_SET_C_HEADER \
    POTHOS_PP_CAT(POTHOS_PP_CAT(set,POTHOS_MPL_LIMIT_SET_SIZE),_c).hpp \
    /**/
#else
#   define AUX778076_SET_C_HEADER \
    POTHOS_PP_CAT(POTHOS_PP_CAT(set,POTHOS_MPL_LIMIT_SET_SIZE),_c)##.hpp \
...
#   include POTHOS_PP_STRINGIZE(Pothos/serialization/impl/mpl/set/AUX778076_SET_C_HEADER)
...
#   define POTHOS_MPL_PREPROCESSED_HEADER set_c.hpp
...
#   define AUX778076_SEQUENCE_NAME_N(n) POTHOS_PP_CAT(POTHOS_PP_CAT(set,n),_c)

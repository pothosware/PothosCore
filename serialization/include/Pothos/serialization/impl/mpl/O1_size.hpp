...
#ifndef POTHOS_MPL_O1_SIZE_HPP_INCLUDED
#define POTHOS_MPL_O1_SIZE_HPP_INCLUDED
...
#include <Pothos/serialization/impl/mpl/aux_/O1_size_impl.hpp>
...
{
    POTHOS_MPL_AUX_LAMBDA_SUPPORT(1, O1_size, (Sequence))
};

POTHOS_MPL_AUX_NA_SPEC(1, O1_size)

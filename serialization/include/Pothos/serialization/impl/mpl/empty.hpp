...
#ifndef POTHOS_MPL_EMPTY_HPP_INCLUDED
#define POTHOS_MPL_EMPTY_HPP_INCLUDED
...
#include <Pothos/serialization/impl/mpl/aux_/empty_impl.hpp>
...
{
    POTHOS_MPL_AUX_LAMBDA_SUPPORT(1,empty,(Sequence))
};

POTHOS_MPL_AUX_NA_SPEC(1, empty)

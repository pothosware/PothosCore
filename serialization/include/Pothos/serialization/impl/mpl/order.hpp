...
#ifndef POTHOS_MPL_ORDER_HPP_INCLUDED
#define POTHOS_MPL_ORDER_HPP_INCLUDED
...
{
    POTHOS_MPL_AUX_LAMBDA_SUPPORT(2,order,(AssociativeSequence,Key))
};

POTHOS_MPL_AUX_NA_SPEC(2, order)

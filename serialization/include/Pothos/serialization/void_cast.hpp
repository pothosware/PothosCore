#ifndef  POTHOS_SERIALIZATION_VOID_CAST_HPP
#define POTHOS_SERIALIZATION_VOID_CAST_HPP
...
#include <Pothos/serialization/impl/type_traits/is_virtual_base_of.hpp>
...
POTHOS_SERIALIZATION_DECL(void const *)
void_upcast(
...
class POTHOS_SERIALIZATION_DECL(POTHOS_PP_EMPTY()) void_caster :
    private Pothos::noncopyable
{
    ...
    friend 
    POTHOS_SERIALIZATION_DECL(void const *)  
    Pothos::serialization::void_downcast(
        extended_type_info const & derived,
        extended_type_info const & base,
        void const * const
    );
    ...
    public void_caster
{
    virtual void const * downcast(void const * const t) const {
        const Derived * d = 
            Pothos::serialization::smart_cast<const Derived *, const Base *>(
    ...
    virtual void const * upcast(void const * const t) const {
        const Base * b = 
            Pothos::serialization::smart_cast<const Base *, const Derived *>(
...
{
    typedef
        POTHOS_DEDUCED_TYPENAME mpl::eval_if<Pothos::is_virtual_base_of<Base,Derived>,
            mpl::identity<

#ifndef POTHOS_SERIALIZATION_PFTO_HPP
#define POTHOS_SERIALIZATION_PFTO_HPP
...
template<class T>
pfto_wrapper< T > make_pfto_wrapper(const T & t, POTHOS_PFTO int){
...
pfto_wrapper< T > make_pfto_wrapper(const pfto_wrapper< T > & t, int){
    ...
    #define POTHOS_PFTO_WRAPPER(T) \
        Pothos::serialization::pfto_wrapper< T >
    #define POTHOS_MAKE_PFTO_WRAPPER(t) \
        Pothos::serialization::make_pfto_wrapper(t, 0)
#else
    #define POTHOS_PFTO_WRAPPER(T) T
    #define POTHOS_MAKE_PFTO_WRAPPER(t) t
#endif

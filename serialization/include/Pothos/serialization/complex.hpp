#ifndef  POTHOS_SERIALIZATION_COMPLEX_HPP
#define POTHOS_SERIALIZATION_COMPLEX_HPP
...
inline void save(
    ...
    const T re = t.real();
    const T im = t.imag();
    ar << Pothos::serialization::make_nvp("real", re);
    ar << Pothos::serialization::make_nvp("imag", im);
}
